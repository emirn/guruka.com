---
title: "Color Clash - Игра для мозга"
description: "Тренируйте тормозной контроль и избирательное внимание с помощью эффекта Струпа. Определяйте цвета и подавляйте автоматическое чтение слов!"
full_width: true
language: "ru"
---
...
<p class="cc-subtitle">Тормозной контроль и избирательное внимание на основе эффекта Струпа</p>
<div class="cc-how-to">
<h3>Как играть</h3>
<ol>
<li>Названия цветов отображаются <strong>другим цветом чернил</strong>.</li>
<li>Следуйте <strong>индикатору правила</strong> и нажмите на правильный цвет, соответствующий текущему правилу.</li>
<li>С повышением уровня правила переключаются между <strong>"Цвет чернил"</strong> и <strong>"Значение слова"</strong>.</li>
<li>Отвечайте до истечения времени!</li>
<li>Бонусные очки за скорость и серию правильных ответов.</li>
</ol>
</div>
<div id="cc-best-display" class="cc-personal-best" style="display:none;">
Лучший результат: <strong id="cc-best-score">0</strong> очков
</div>
<button class="cc-btn-primary" id="cc-start-btn">Начать игру</button>
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">Очки</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">Серия</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">Смена правил</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">Нажмите на цвет чернил</div>
...
<div class="cc-playing-hint"><strong>1-4</strong> для ответа · <strong>Esc</strong> для паузы</div>
<button class="gk-finish-btn" id="cc-finish-btn">Завершить игру</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">Пауза</div>
<button class="cc-btn-primary" id="cc-resume-btn">Продолжить</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; Новый рекорд!</div>
...
<div class="cc-complete-stat-label">Уровень</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Точность</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Лучшая серия</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Лучший результат</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">Играть снова</button>
<a href="/ru/games/" class="cc-back-link">&larr; Все игры</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="cc-share-btn">&#128279; Поделиться результатом</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">Ссылка скопирована!</div>
</div>
</div>
</div>
...
elModifierBadge.textContent = 'Тройной Stroop';
} else if (doesRuleSwitchMidLevel(state.level)) {
elModifierBadge.textContent = 'Смена внутри уровня';
} else {
elModifierBadge.textContent = 'Смена правил';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: 'Определяйте цвет, а не слово', desc: 'Названия цветов отображаются другим цветом чернил. Следуйте индикатору правила и выбирайте правильный ответ!'},
{icon: '\uD83D\uDD04', title: 'Правила меняются с уровнем', desc: 'На высоких уровнях правила переключаются между "Цвет чернил" и "Значение слова". Будьте внимательны!'},
{icon: '\u26A1', title: 'Отвечайте быстро!', desc: 'Отвечайте до истечения времени. Бонусные очки за скорость и серию правильных ответов.', final: true}
];
var ccWizardStep = 0;
...
GK.shareResult(state.score, 'Color Clash', '/ru/games/color-clash/', 'cc-share-copied');
});
