---
title: "Quick Sort - Игра для мозга"
description: "Тренируйте скорость категоризации и переключение задач. Сортируйте предметы по правильным категориям, пока правила меняются каждые несколько раундов!"
full_width: true
language: "ru"
---
...
<p class="qs-subtitle">Скорость категоризации и переключение задач</p>
<div class="qs-how-to">
<h3>Как играть</h3>
<ol>
<li>На экране появится предмет (число, фигура или слово).</li>
<li>Две категории отображаются <strong>слева и справа</strong>.</li>
<li>Нажмите на правильную сторону, чтобы отсортировать предмет.</li>
<li>Правила сортировки <strong>меняются</strong> каждые несколько раундов!</li>
<li>Скорость и серия правильных ответов дают бонусные очки.</li>
</ol>
</div>
<div id="qs-best-display" class="qs-personal-best" style="display:none;">
Лучший результат: <strong id="qs-best-score">0</strong> очков
</div>
<button class="qs-btn-primary" id="qs-start-btn">Начать игру</button>
...
<div class="qs-header">
<div class="qs-stat">
<div class="qs-stat-label">Очки</div>
<div class="qs-stat-value" id="qs-score">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Серия</div>
<div class="qs-stat-value" id="qs-streak">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Уровень</div>
<div class="qs-stat-value" id="qs-level">1</div>
</div>
</div>
<div class="qs-level-info">
<span class="qs-level-text">Уровень <span id="qs-level-text">1</span></span>
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">Смена правил</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">Сортировка: Чётные / Нечётные</div>
...
<span class="qs-label" id="qs-label-left">Чётные</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">Нечётные</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint"><strong>A / &#8592;</strong> влево &middot; <strong>D / &#8594;</strong> вправо &middot; <strong>Esc</strong> пауза</div>
<button class="gk-finish-btn" id="qs-finish-btn">Завершить игру</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">Пауза</div>
<button class="qs-btn-primary" id="qs-resume-btn">Продолжить</button>
</div>
...
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; Новый рекорд!</div>
...
<div class="qs-complete-stat-label">Уровень</div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Точность</div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Лучшая серия</div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Лучший результат</div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">Играть снова</button>
<a href="/ru/games/" class="qs-back-link">&larr; Все игры</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="qs-share-btn">&#128279; Поделиться результатом</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">Ссылка скопирована!</div>
</div>
</div>
</div>

<div class="qs-level-up-toast" id="qs-level-toast">Level Up!</div>
<div class="qs-rule-toast" id="qs-rule-toast">Новое правило!</div>
...
var NOT_FRUITS = ['Машина', 'Книга', 'Стол'];
...
return {
name: 'Большие / Маленькие',
leftLabel: 'Большие (\u226550)',
rightLabel: 'Маленькие (<50)',
generate: function() {
var n = randInt(1, 100);
return {
display: String(n),
...
return {
name: 'Фигура / Не фигура',
leftLabel: 'Фигура',
rightLabel: 'Не фигура',
generate: function() {
...
return {
name: 'Чётное и большое / Другое',
leftLabel: 'Чётн.+больш.',
rightLabel: 'Другое',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Нечётное и маленькое / Другое',
leftLabel: 'Нечётн.+мал.',
rightLabel: 'Другое',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Фрукт или большое / Другое',
leftLabel: 'Фрукт/больш.',
rightLabel: 'Другое',
generate: function() {
...
return {
name: 'Фигура или чётное / Другое',
leftLabel: 'Фигура/чётн.',
rightLabel: 'Другое',
generate: function() {
...
elRuleBadge.textContent = 'Смена правил';
} else {
...
elRuleIndicator.textContent = 'Сортировка: ' + state.currentRule.name;
...
elRuleToast.textContent = 'Новое правило: ' + ruleName;
...
showConfetti();
trophy.textContent = '\uD83C\uDF89';
title.textContent = 'Великолепно!';
elNewBest.className = 'qs-new-best-enhanced';
elNewBest.innerHTML = '\uD83C\uDF1F Великолепно! Новый рекорд!';
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: 'Быстро сортируйте предметы', desc: 'На экране появляется предмет. Нажмите на правильную категорию (влево или вправо), чтобы его отсортировать!'},
{icon: '\uD83D\uDD00', title: 'Правила меняются!', desc: 'Каждые несколько раундов правила сортировки меняются. Будьте внимательны и реагируйте быстро!'},
{icon: '\u26A1', title: 'Отвечайте быстро!', desc: 'Отвечайте до истечения времени. Скорость и серия правильных ответов дают бонусные очки!', final: true}
];
var qsWizardStep = 0;
...
GK.shareResult(state.score, 'Quick Sort', '/ru/games/quick-sort/', 'qs-share-copied');
});
