---
title: "Number Crunch - Игра для мозга"
description: "Тренируйте навыки устного счёта и когнитивную гибкость. Решайте уравнения с пропущенными элементами и адаптируйтесь к модификаторам правил!"
full_width: true
language: "ru"
---
...
<p class="nc-subtitle">Устный счёт и когнитивная гибкость</p>
<div class="nc-how-to">
<h3>Как играть</h3>
<ol>
<li>На экране появится уравнение с пропущенным элементом.</li>
<li>Выберите <strong>правильный ответ</strong> из четырёх вариантов.</li>
<li>Начиная с уровня 6 появляются <strong>модификаторы правил</strong> (например: «Умножить на 2»).</li>
<li>Отвечайте до истечения времени!</li>
<li>За скорость и серию правильных ответов начисляются бонусные очки.</li>
</ol>
</div>
<div id="nc-best-display" class="nc-personal-best" style="display:none;">
Лучший результат: <strong id="nc-best-score">0</strong> очков
</div>
<button class="nc-btn-primary" id="nc-start-btn">Начать игру</button>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">Очки</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">Серия</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">Модификатор активен</span>
</div>
...
<div class="nc-playing-hint">Клавиши <strong>1-4</strong> для ответа · <strong>Esc</strong> для паузы</div>
<button class="gk-finish-btn" id="nc-finish-btn">Завершить игру</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">Пауза</div>
<button class="nc-btn-primary" id="nc-resume-btn">Продолжить</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; Новый рекорд!</div>
...
<div class="nc-complete-stat-label">Уровень</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Точность</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Лучшая серия</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Лучший результат</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">Играть снова</button>
<a href="/ru/games/" class="nc-back-link">&larr; Все игры</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="nc-share-btn">&#128279; Поделиться результатом</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">Ссылка скопирована!</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: 'Умножить на 2', apply: function(n) { return n * 2; } },
{ name: 'Прибавить 10', apply: function(n) { return n + 10; } },
{ name: 'Вычесть 5', apply: function(n) { return n - 5; } },
{ name: 'Разделить пополам', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', затем ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'Модификатор активен';
} else {
...
elNewBest.innerHTML = 'uD83CuDF1F Великолепно! Новый рекорд!';
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: 'Решайте уравнения', desc: 'На экране появится уравнение с пропущенным ответом. Выберите правильный вариант!'},
{icon: '\u2728', title: 'Следите за модификаторами', desc: 'Начиная с уровня 6 модификаторы правил изменяют ответ (например: «Умножить на 2»).'},
{icon: '\u26A1', title: 'Будьте быстрее!', desc: 'Отвечайте до истечения времени. Скорость = бонусные очки!', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/ru/games/number-crunch/', 'nc-share-copied');
});
