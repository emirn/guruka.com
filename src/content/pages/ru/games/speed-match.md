---
title: "Speed Match - Игра для мозга"
description: "Проверьте свою скорость обработки информации и рабочую память в этой динамичной игре на сопоставление символов. Сравнивайте символы и реагируйте как можно быстрее!"
full_width: true
language: "ru"
---
...
<p class="sm-subtitle">Какова ваша скорость обработки информации?</p>
<div class="sm-how-to">
<h3>Как играть</h3>
<ol>
<li>Каждый раунд на экране появляется символ.</li>
<li>Определите, <strong>совпадает ли он</strong> с символом из предыдущего раунда.</li>
<li>Если совпадает, нажмите <strong>Совпадает</strong>, если нет -- <strong>Не совпадает</strong>.</li>
<li>Отвечайте до истечения времени, иначе ответ будет засчитан как неверный!</li>
<li>С каждым уровнем игра становится быстрее и сложнее.</li>
</ol>
</div>
<div class="sm-kbd-hints">
<span class="sm-kbd-hint"><span class="sm-kbd">A</span> / <span class="sm-kbd">&larr;</span> Не совпадает</span>
<span class="sm-kbd-hint"><span class="sm-kbd">D</span> / <span class="sm-kbd">&rarr;</span> Совпадает</span>
<span class="sm-kbd-hint"><span class="sm-kbd">Esc</span> Пауза</span>
</div>
<div id="sm-best-display" class="sm-personal-best" style="display:none;">
Лучший результат: <strong id="sm-best-score">0</strong> очков
</div>
<button class="sm-btn-primary" id="sm-start-btn">Начать игру</button>
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">Очки</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Серия</div>
...
<div class="sm-playing-kbd-hint">Нажмите <strong>Esc</strong> для паузы</div>
<button class="gk-finish-btn" id="sm-finish-btn">Завершить игру</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">Пауза</div>
<button class="sm-btn-primary" id="sm-resume-btn">Продолжить</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; Новый рекорд!</div>
...
<div class="sm-complete-stat-label">Уровень</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Точность</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Лучшая серия</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Лучший результат</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">Играть снова</button>
<a href="/ru/games/" class="sm-back-link">&larr; Все игры</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="sm-share-btn">&#128279; Поделиться результатом</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">Ссылка скопирована!</div>
</div>
</div>
</div>
...
/* -- Start game flow -- */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'На экране появится символ', desc: 'Каждый раунд отображается символ. Внимательно смотрите!'},
{icon: '\u2194\uFE0F', title: 'Совпадает? Не совпадает?', desc: 'Совпадает ли символ с предыдущим? Нажмите, чтобы ответить.'},
{icon: '\u26A1', title: 'Быстрее!', desc: 'Отвечайте до истечения времени. Скорость = бонусные очки!', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/ru/games/speed-match/', 'sm-share-copied');
});
