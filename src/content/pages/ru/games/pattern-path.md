---
title: "Pattern Path - Игра для мозга"
description: "Тренируйте распознавание паттернов и подвижный интеллект. Найдите недостающий элемент в визуальных последовательностях, состоящих из форм, цветов и преобразований!"
full_width: true
language: "ru"
---
...
<p class="pp-subtitle">Визуальное распознавание паттернов и подвижный интеллект</p>
<div class="pp-how-to">
<h3>Как играть</h3>
<ol>
<li>В последовательности фигур будет показан <strong>недостающий элемент</strong> (?).</li>
<li>Найдите паттерн (изменение цвета, формы, размера, вращения).</li>
<li>Выберите <strong>правильный ответ</strong> из четырёх вариантов.</li>
<li>Ответьте до истечения времени!</li>
...
Лучший результат: <strong id="pp-best-score">0</strong> очков
</div>
<button class="pp-btn-primary" id="pp-start-btn">Начать игру</button>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">Очки</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">Серия</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">Цвет</span>
</div>
...
<div class="pp-playing-hint">Клавиши <strong>1-4</strong> для ответа &middot; <strong>Esc</strong> для паузы</div>
<button class="gk-finish-btn" id="pp-finish-btn">Завершить игру</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">Пауза</div>
<button class="pp-btn-primary" id="pp-resume-btn">Продолжить</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; Новый рекорд!</div>
...
<div class="pp-complete-stat-label">Уровень</div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Точность</div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Лучшая серия</div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Лучший результат</div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">Играть снова</button>
<a href="/ru/games/" class="pp-back-link">&larr; Все игры</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="pp-share-btn">&#128279; Поделиться результатом</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">Ссылка скопирована!</div>
</div>
</div>
</div>
...
if (lvl <= 3) return 'Цвет';
if (lvl <= 6) return 'Форма';
if (lvl <= 9) return 'Цвет + Форма';
if (lvl <= 12) return 'Вращение';
if (lvl <= 16) return 'Размер + Кол-во';
return 'Мульти-атрибуты';
}
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: 'Найдите недостающий паттерн', desc: 'В последовательности фигур будет показан недостающий элемент. Найдите паттерн!'},
{icon: '\uD83C\uDFA8', title: 'Атрибуты меняются', desc: 'Паттерны включают цвет, форму, размер и вращение. На высоких уровнях комбинируются несколько атрибутов.'},
{icon: '\u26A1', title: 'Отвечайте быстро!', desc: 'Выберите правильную фигуру до истечения времени. Скорость и серия правильных ответов дают бонусные очки!', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/ru/games/pattern-path/', 'pp-share-copied');
});
