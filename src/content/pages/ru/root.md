---
title: "GURUKA — Тренируйте мозг и ясность ума"
description: "Игры для тренировки мозга и памяти и медитации с голосовым сопровождением для улучшения памяти, концентрации и ясности ума. Играйте каждый день и отслеживайте свой прогресс."
full_width: true
blog_grid: true
blog_grid_title: "Из блога"
blog_grid_limit: 3
language: "ru"
---
...
<h2>Медитации</h2>
<p>Медитации с голосовым сопровождением для спокойствия, концентрации и благополучия</p>
<p class="gk-free-tag">Бесплатно и без рекламы</p>
</div>
<div class="gk-med-cards">
<a href="/ru/meditate/calm-and-stress-relief/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #818cf8, #a78bfa);"></div>
<span>Спокойствие и снятие стресса</span>
</a>
<a href="/ru/meditate/focus-and-clarity/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #3b82f6, #1e40af);"></div>
<span>Фокус и ясность ума</span>
</a>
<a href="/ru/meditate/sleep-and-wind-down/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #6366f1, #4338ca);"></div>
<span>Сон и расслабление</span>
</a>
<a href="/ru/meditate/morning-energy/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #f59e0b, #d97706);"></div>
<span>Утренняя энергия</span>
</a>
<a href="/ru/meditate/loving-kindness/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #f472b6, #ec4899);"></div>
<span>Медитация доброты</span>
</a>
<a href="/ru/meditate/gratitude/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #fbbf24, #f59e0b);"></div>
<span>Благодарность</span>
</a>
<a href="/ru/meditate/body-scan-and-tension-release/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #2dd4bf, #14b8a6);"></div>
<span>Сканирование тела</span>
</a>
</div>
</div>
...
<div class="gk-section">
<div class="gk-section-header">
<h2>Игры для мозга</h2>
<p>Тренируйте мозг с помощью 7 игр, развивающих различные когнитивные навыки</p>
<p class="gk-free-tag">Бесплатно и без рекламы</p>
</div>
<div class="gk-cards">
<a href="/ru/games/speed-match/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(15,144,114,0.1); color: #0f9072;">&#9889;</div>
<h3>Speed Match</h3>
<p>Улучшите скорость обработки информации с быстрым сопоставлением символов</p>
</a>
<a href="/ru/games/memory-matrix/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;">&#9638;</div>
<h3>Memory Matrix</h3>
<p>Запоминайте паттерны на сетке и укрепляйте пространственную память</p>
</a>
<a href="/ru/games/sequence-recall/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(16,185,129,0.1); color: #10b981;">&#9776;</div>
<h3>Sequence Recall</h3>
<p>Тренируйте рабочую память с помощью последовательностей двойного трека</p>
</a>
<a href="/ru/games/number-crunch/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(99,102,241,0.1); color: #6366f1;">&#129518;</div>
<h3>Number Crunch</h3>
<p>Оттачивайте устный счёт с уравнениями и модификаторами правил на время</p>
</a>
<a href="/ru/games/color-clash/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(236,72,153,0.1); color: #ec4899;">&#127912;</div>
<h3>Color Clash</h3>
<p>Укрепляйте тормозной контроль с помощью цветовых заданий на основе эффекта Струпа</p>
</a>
<a href="/ru/games/quick-sort/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(249,115,22,0.1); color: #f97316;">&#128451;</div>
<h3>Quick Sort</h3>
<p>Развивайте навык переключения задач с меняющимися правилами сортировки</p>
</a>
<a href="/ru/games/pattern-path/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(20,184,166,0.1); color: #14b8a6;">&#129513;</div>
<h3>Pattern Path</h3>
<p>Тренируйте распознавание паттернов с визуальными головоломками</p>
</a>
</div>
</div>
</div>
