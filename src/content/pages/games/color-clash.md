---
title: "Color Clash - Brain Training Game"
...
<div class="cc-stat">
<div class="cc-stat-label">Streak</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">Rule Switching</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">Tap the INK COLOR</div>
...
<div class="cc-playing-hint">Press <strong>1-4</strong> to answer &middot; <strong>Esc</strong> to pause</div>
<button class="gk-finish-btn" id="cc-finish-btn">Finish Game</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">Paused</div>
<button class="cc-btn-primary" id="cc-resume-btn">Resume</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; New Best!</div>
...
<div class="cc-complete-stat-label">Level Reached</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Accuracy</div>
...
<button class="cc-btn-primary" id="cc-play-again-btn">Play Again</button>
...
elModifierBadge.textContent = 'Mid-Level Switching';
} else {
elModifierBadge.textContent = 'Rule Switching';
}
} else {
...
GK.shareResult(state.score, 'Color Clash', '/games/color-clash/', 'cc-share-copied');
});
