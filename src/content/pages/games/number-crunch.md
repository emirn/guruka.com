---
title: "Number Crunch - Brain Training Game"
...
<input type="text" id="nc-player-name" class="gk-name-input" placeholder="Your name (for sharing)" maxlength="20">
</div>
...
<div class="nc-stat">
<div class="nc-stat-label">Streak</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">Modifier Active</span>
</div>
...
<div class="nc-playing-hint">Press <strong>1-4</strong> to answer &middot; <strong>Esc</strong> to pause</div>
<button class="gk-finish-btn" id="nc-finish-btn">Finish Game</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">Paused</div>
<button class="nc-btn-primary" id="nc-resume-btn">Resume</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; New Best!</div>
...
<div class="nc-complete-stat-label">Level Reached</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Accuracy</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Best Streak</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Personal Best</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">Play Again</button>
<a href="/games/" class="nc-back-link">&larr; Back to Games</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Challenge a Friend</div>
<button class="gk-share-btn" id="nc-share-btn">&#128279; Share Your Score</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">Link copied!</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: 'Double it', apply: function(n) { return n * 2; } },
{ name: 'Add 10', apply: function(n) { return n + 10; } },
{ name: 'Subtract 5', apply: function(n) { return n - 5; } },
{ name: 'Half it', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', then ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'Modifiers Active';
} else {
...
GK.shareResult(state.score, 'Number Crunch', '/games/number-crunch/', 'nc-share-copied');
});
