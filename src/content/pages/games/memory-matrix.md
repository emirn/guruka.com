...
Personal Best: <strong id="mm-best-value">none yet</strong>
</div>
<div class="mm-how-to">
<h3>How to Play</h3>
<ul>
<li>Watch the pattern &mdash; cells highlight one by one.</li>
<li>Memorize which cells light up.</li>
<li>Tap the same cells from memory.</li>
<li>From level 8, <strong>order matters</strong> &mdash; tap in the right sequence!</li>
</ul>
</div>

<button class="mm-btn mm-btn-primary" onclick="mmStartGame()">Start Game</button>
...
<h2 class="mm-title">Game Complete!</h2>
