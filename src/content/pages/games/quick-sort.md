---
title: "Quick Sort - Brain Training Game"
...
<div class="qs-stat">
<div class="qs-stat-label">Streak</div>
...
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">Rule Change</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">Sort: Even / Odd</div>
...
<span class="qs-label" id="qs-label-left">Even</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">Odd</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint">Press <strong>A / &#8592;</strong> for left &middot; <strong>D / &#8594;</strong> for right &middot; <strong>Esc</strong> to pause</div>
<button class="gk-finish-btn" id="qs-finish-btn">Finish Game</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">Paused</div>
<button class="qs-btn-primary" id="qs-resume-btn">Resume</button>
</div>
...
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; New Best!</div>
...
<div class="qs-complete-stat-label">Level Reached</div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Accuracy</div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Best Streak</div>
...
<div class="qs-rule-toast" id="qs-rule-toast">New Rule!</div>
...
return {
name: 'Shape / Not Shape',
leftLabel: 'Shape',
rightLabel: 'Not Shape',
generate: function() {
...
return {
name: 'Fruit / Not Fruit',
leftLabel: 'Fruit',
rightLabel: 'Not Fruit',
generate: function() {
...
return {
name: 'Shape OR Even / Other',
leftLabel: 'Shape/Even',
rightLabel: 'Other',
generate: function() {
...
elRuleBadge.textContent = 'Rules Alternate';
} else {
...
elRuleIndicator.textContent = 'Sort: ' + state.currentRule.name;
...
elRuleToast.textContent = 'New Rule: ' + ruleName;
...
GK.shareResult(state.score, 'Quick Sort', '/games/quick-sort/', 'qs-share-copied');
});
