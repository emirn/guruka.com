---
title: "アファメーション＆瞑想ビジュアル"
description: "カスタムアファメーションテキスト付きの全画面リラクゼーションビジュアル。自分だけのアファメーションを作成、ブラウザにプライベートに保存。"
full_width: true
language: "ja"
---
<style>
...
<div class="vh-header">
<h1>瞑想ビジュアル</h1>
<p>リラクゼーションと集中のための落ち着いたフルスクリーンアニメーション。アファメーションテキストを入力して表示。<br>アカウント不要。</p>
</div>
