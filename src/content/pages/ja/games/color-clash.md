---
title: "Color Clash - 脳トレゲーム"
description: "ストループ効果を使って抑制制御と選択的注意を鍛えましょう。色を識別して、自動的な単語読みを抑えてください！"
full_width: true
language: "ja"
---
...
<h2>Color Clash</h2>
<p class="cc-subtitle">Stroopベースの抑制制御と選択的注意</p>
<div class="cc-how-to">
<h3>遊び方</h3>
<ol>
<li>色の名前が<strong>別のインクの色</strong>で表示されます。</li>
<li><strong>ルールインジケーター</strong>に従って、現在のルールに合った正しい色をタップしてください。</li>
<li>レベルが上がると、ルールが<strong>「インクの色」</strong>と<strong>「単語の意味」</strong>の間で切り替わります。</li>
<li>時間切れになる前に答えてください！</li>
<li>スピードと連続正解でボーナスポイントが獲得できます。</li>
</ol>
</div>
<div id="cc-best-display" class="cc-personal-best" style="display:none;">
自己ベスト: <strong id="cc-best-score">0</strong> ポイント
</div>
<button class="cc-btn-primary" id="cc-start-btn">ゲームスタート</button>
<div id="cc-challenge-banner-wrap"></div>
<input type="text" id="cc-player-name" class="gk-name-input" placeholder="あなたの名前（共有用）" maxlength="20">
</div>
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">スコア</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">連続</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">ルール切替</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">インクの色をタップ</div>
...
<div class="cc-playing-hint"><strong>1-4</strong>キーで回答 · <strong>Esc</strong>キーで一時停止</div>
<button class="gk-finish-btn" id="cc-finish-btn">ゲーム終了</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">一時停止中</div>
<button class="cc-btn-primary" id="cc-resume-btn">再開</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; 新記録！</div>
...
<div class="cc-complete-stat-label">到達レベル</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">正確性</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">最高連続</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">自己ベスト</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">もう一度プレイ</button>
<a href="/ja/games/" class="cc-back-link">&larr; すべてのゲーム</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">友達にチャレンジ</div>
<button class="gk-share-btn" id="cc-share-btn">&#128279; 結果をシェア</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">リンクをコピーしました！</div>
</div>
</div>
</div>
...
elModifierBadge.textContent = 'トリプルStroop';
} else if (doesRuleSwitchMidLevel(state.level)) {
elModifierBadge.textContent = 'レベル内切替';
} else {
elModifierBadge.textContent = 'ルール切替';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: '色を読んで、単語を読まない', desc: '色の名前が別のインクの色で表示されます。ルールインジケーターに従って正しい答えを選びましょう！'},
{icon: '\uD83D\uDD04', title: 'レベルアップでルールが変わる', desc: '高いレベルでは「インクの色」と「単語の意味」のルールが切り替わります。注意を怠らないで！'},
...
GK.shareResult(state.score, 'Color Clash', '/ja/games/color-clash/', 'cc-share-copied');
});
