...
<p class="cc-subtitle">色を読み取り、惑わされないで</p>
<div id="cc-best-display" class="cc-personal-best">
自己ベスト: <strong id="cc-best-score">まだなし</strong>
</div>
<div class="cc-how-to">
<h3>遊び方</h3>
<ul>
<li>色の名前が<strong style="color:#ec4899">別のインクの色</strong>で表示されます。</li>
<li><strong>ルールインジケーター</strong>に従って、現在のルールに合った正しい色をタップしてください。</li>
<li>レベルが上がると、ルールが<strong style="color:#ec4899">「インクの色」</strong>と<strong style="color:#3b82f6">「単語の意味」</strong>の間で切り替わります。</li>
