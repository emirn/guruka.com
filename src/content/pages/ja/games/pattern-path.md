---
title: "Pattern Path - 脳トレゲーム"
description: "パターン認識と流動性知能を鍛えましょう。形、色、変換で構成される視覚的なシーケンスから欠けている要素を見つけてください！"
full_width: true
language: "ja"
---
...
<h2>Pattern Path</h2>
<p class="pp-subtitle">視覚的パターン認識と流動性知能</p>
<div class="pp-how-to">
<h3>遊び方</h3>
<ol>
<li>形のシーケンスに<strong>欠けている要素</strong>（？）が表示されます。</li>
<li>パターンを見つけましょう（色、形、サイズ、回転の変化）。</li>
<li>4つの選択肢から<strong>正しい補完</strong>を選びましょう。</li>
<li>時間切れになる前に答えてください！</li>
<li>スピードと連続正解でボーナスポイントが獲得できます。</li>
</ol>
</div>
<div id="pp-best-display" class="pp-personal-best" style="display:none;">
自己ベスト: <strong id="pp-best-score">0</strong> ポイント
</div>
<button class="pp-btn-primary" id="pp-start-btn">ゲームスタート</button>
<div id="pp-challenge-banner-wrap"></div>
<input type="text" id="pp-player-name" class="gk-name-input" placeholder="あなたの名前（共有用）" maxlength="20">
</div>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">スコア</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">連続</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">色</span>
</div>
...
<div class="pp-playing-hint"><strong>1-4</strong>キーで回答 &middot; <strong>Esc</strong>キーで一時停止</div>
<button class="gk-finish-btn" id="pp-finish-btn">ゲーム終了</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">一時停止中/div>
<button class="pp-btn-primary" id="pp-resume-btn">再開</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; 新記録！</div>
...
<div class="pp-complete-stat-label">到達レベル/div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">正確性/div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">最高連続/div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">自己ベスト/div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">もう一度プレイ</button>
<a href="/ja/games/" class="pp-back-link">&larr; すべてのゲーム</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">友達にチャレンジ</div>
<button class="gk-share-btn" id="pp-share-btn">&#128279; 結果をシェア</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">リンクをコピーしました！</div>
</div>
</div>
</div>
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: '欠けているパターンを見つけよう', desc: '形のシーケンスに欠けている要素が表示されます。パターンを見つけましょう！'},
{icon: '\uD83C\uDFA8', title: '属性が変化する', desc: 'パターンには色、形、サイズ、回転が含まれます。高いレベルでは複数の属性が組み合わされます。'},
{icon: '\u26A1', title: '素早く答えよう！', desc: '時間切れになる前に正しい形を選びましょう。スピードと連続正解でボーナスポイントが獲得できます！', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/ja/games/pattern-path/', 'pp-share-copied');
});
