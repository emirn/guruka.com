---
title: "Quick Sort - 脳トレゲーム"
description: "カテゴリー分けのスピードとタスク切り替えを鍛えましょう。数ラウンドごとにルールが変わる中、アイテムを正しいカテゴリーに仕分けしてください！"
full_width: true
language: "ja"
---
...
<h2>Quick Sort</h2>
<p class="qs-subtitle">カテゴリー分けスピードとタスク切り替え</p>
<div class="qs-how-to">
<h3>遊び方</h3>
<ol>
<li>アイテム（数字、形、または単語）が画面に表示されます。</li>
<li>2つのカテゴリーが<strong>左右</strong>に表示されます。</li>
<li>正しい側をタップしてアイテムを仕分けしましょう。</li>
<li>仕分けルールが数ラウンドごとに<strong>切り替わります</strong>！</li>
<li>スピードと連続正解でボーナスポイントが獲得できます。</li>
</ol>
</div>
<div id="qs-best-display" class="qs-personal-best" style="display:none;">
自己ベスト: <strong id="qs-best-score">0</strong> ポイント
</div>
<button class="qs-btn-primary" id="qs-start-btn">ゲームスタート</button>
<div id="qs-challenge-banner-wrap"></div>
<input type="text" id="qs-player-name" class="gk-name-input" placeholder="あなたの名前（共有用）" maxlength="20">
</div>
...
<div class="qs-header">
<div class="qs-stat">
<div class="qs-stat-label">スコア</div>
<div class="qs-stat-value" id="qs-score">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">連続</div>
...
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">ルール切替</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">仕分け: 偶数 / 奇数</div>
...
<span class="qs-label" id="qs-label-left">偶数</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">奇数</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint"><strong>A / Drücke <strong>A / &#8592;</strong> für links &middot; <strong>D / &#8594;</strong> für rechts &middot; <strong>Esc</strong> zum Pausieren#8592;</strong>キーで左 &middot; <strong>D / Drücke <strong>A / &#8592;</strong> für links &middot; <strong>D / &#8594;</strong> für rechts &middot; <strong>Esc</strong> zum Pausieren#8594;</strong>キーで右 &middot; <strong>Esc</strong>キーで一時停止</div>
<button class="gk-finish-btn" id="qs-finish-btn">ゲーム終了</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">一時停止中/div>
<button class="qs-btn-primary" id="qs-resume-btn">再開</button>
</div>
...
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; 新記録！</div>
...
<div class="qs-complete-stat-label">到達レベル/div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">正確性/div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">最高連続/div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">自己ベスト/div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">もう一度プレイ</button>
<a href="/ja/games/" class="qs-back-link">&larr; すべてのゲーム</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">友達にチャレンジ</div>
<button class="gk-share-btn" id="qs-share-btn">&#128279; 結果をシェア</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">リンクをコピーしました！</div>
</div>
</div>
</div>

<div class="qs-level-up-toast" id="qs-level-toast">Level Up!</div>
<div class="qs-rule-toast" id="qs-rule-toast">新しいルール！</div>
...
/* ── Rule definitions ── */
var SHAPES = ['丸', '四角', '三角'];
var FRUITS = ['リンゴ', 'バナナ', 'サクランボ'];
var NOT_FRUITS = ['車', '本', '机'];
...
elRuleIndicator.textContent = '仕分け: ' + state.currentRule.name;
...
elRuleToast.textContent = '新しいルール: ' + ruleName;
...
elNewBest.innerHTML = '\uD83C\uDF1F すばらしい！新記録！';
elNewBest.style.display = 'inline-block';
} else {
trophy.textContent = '\uD83C\uDFC6';
title.textContent = 'お疲れさまでした！';
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: 'アイテムを素早く仕分け', desc: 'アイテムが画面に表示されます。正しいカテゴリー（左または右）をタップして仕分けしましょう！'},
{icon: '\uD83D\uDD00', title: 'ルールが変わる！', desc: '数ラウンドごとに仕分けルールが切り替わります。注意を怠らず、素早く対応しましょう！'},
{icon: '\u26A1', title: '素早く答えよう！', desc: '時間切れになる前に答えましょう。スピードと連続正解でボーナスポイントが獲得できます！', final: true}
];
var qsWizardStep = 0;
...
var btnLabel = s.final ? 'ゲームスタート' : '次へ';
...
GK.shareResult(state.score, 'Quick Sort', '/ja/games/quick-sort/', 'qs-share-copied');
});
