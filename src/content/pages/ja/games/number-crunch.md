---
title: "Number Crunch - 脳トレゲーム"
description: "暗算スキルと認知の柔軟性を鍛えましょう。欠けた要素のある方程式を解いて、ルールモディファイアに対応してください！"
full_width: true
language: "ja"
---
...
<input type="text" id="nc-player-name" class="gk-name-input" placeholder="あなたの名前（共有用）" maxlength="20">
</div>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">スコア</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">連続</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">モディファイア有効</span>
</div>
...
<div class="nc-playing-hint"><strong>1-4</strong>キーで回答 · <strong>Esc</strong>キーで一時停止</div>
<button class="gk-finish-btn" id="nc-finish-btn">ゲーム終了</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">一時停止中</div>
<button class="nc-btn-primary" id="nc-resume-btn">再開</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; 新記録！</div>
...
<div class="nc-complete-stat-label">到達レベル</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">正確性</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">最高連続</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">自己ベスト</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">もう一度プレイ</button>
<a href="/ja/games/" class="nc-back-link">&larr; すべてのゲーム</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">友達にチャレンジ</div>
<button class="gk-share-btn" id="nc-share-btn">&#128279; 結果をシェア</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">リンクをコピーしました！</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: '2倍にする', apply: function(n) { return n * 2; } },
{ name: '10を足す', apply: function(n) { return n + 10; } },
{ name: '5を引く', apply: function(n) { return n - 5; } },
{ name: '半分にする', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + '、次に' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'モディファイア有効';
} else {
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: '方程式を解こう', desc: '答えが欠けた方程式が表示されます。正しい答えを選んでください！'},
{icon: '\u2728', title: 'モディファイアに注意', desc: 'レベル6からルールモディファイアが答えを変えます（例：「2倍にする」）。'},
{icon: '\u26A1', title: 'すばやく！', desc: '時間切れになる前に答えてください。速さ＝ボーナスポイント！', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/ja/games/number-crunch/', 'nc-share-copied');
});
