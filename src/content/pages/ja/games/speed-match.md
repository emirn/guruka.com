---
title: "Speed Match - 脳トレゲーム"
description: "このスピーディーなシンボルマッチングゲームで処理速度とワーキングメモリをテストしましょう。シンボルを比較してすばやく反応してください！"
full_width: true
language: "ja"
---
...
<h2>Speed Match</h2>
<p class="sm-subtitle">あなたの処理速度はどれくらい？</p>
<div class="sm-how-to">
<h3>遊び方</h3>
<ol>
<li>毎ラウンド、画面にシンボルが表示されます。</li>
<li>前のラウンドのシンボルと<strong>同じかどうか</strong>を判断してください。</li>
<li>同じなら<strong>同じ</strong>、違うなら<strong>違う</strong>をクリックしてください。</li>
<li>時間切れになる前に答えてください。さもないと不正解になります！</li>
<li>レベルが上がると、ゲームはより速く難しくなります。</li>
</ol>
</div>
<div class="sm-kbd-hints">
<span class="sm-kbd-hint"><span class="sm-kbd">A</span> / <span class="sm-kbd">&larr;</span> 違う</span>
<span class="sm-kbd-hint"><span class="sm-kbd">D</span> / <span class="sm-kbd">&rarr;</span> 同じ</span>
<span class="sm-kbd-hint"><span class="sm-kbd">Esc</span> 一時停止</span>
</div>
<div id="sm-best-display" class="sm-personal-best" style="display:none;">
自己ベスト: <strong id="sm-best-score">0</strong> ポイント
</div>
<button class="sm-btn-primary" id="sm-start-btn">ゲームスタート</button>
<div id="sm-challenge-banner-wrap"></div>
<input type="text" id="sm-player-name" class="gk-name-input" placeholder="あなたの名前（共有用）" maxlength="20">
</div>
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">スコア</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">連続</div>
...
<div class="sm-playing-kbd-hint"><strong>Esc</strong>キーで一時停止</div>
<button class="gk-finish-btn" id="sm-finish-btn">ゲーム終了</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">一時停止中</div>
<button class="sm-btn-primary" id="sm-resume-btn">再開</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; 新記録！</div>
...
<div class="sm-complete-stat-label">到達レベル</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">正確性</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">最高連続</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">自己ベスト</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">もう一度プレイ</button>
<a href="/ja/games/" class="sm-back-link">&larr; すべてのゲーム</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">友達にチャレンジ</div>
<button class="gk-share-btn" id="sm-share-btn">&#128279; 結果をシェア</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">リンクをコピーしました！</div>
</div>
</div>
</div>
...
elNewBest.innerHTML = 'uD83CuDF1F すばらしい！新記録！';
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'シンボルが画面に表示されます', desc: '毎ラウンド、シンボルが表示されます。よく見てください！'},
{icon: '\u2194\uFE0F', title: '同じ？違う？', desc: '前のシンボルと同じですか？タップして答えてください。'},
{icon: '\u26A1', title: 'すばやく！', desc: '時間切れになる前に反応してください。速さ＝ボーナスポイント！', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/ja/games/speed-match/', 'sm-share-copied');
});
