---
title: "細胞分裂 - アファメーションビジュアル"
description: "瞑想的なループで成長し分裂する細胞。. カスタムアファメーションテキストを追加。ブラウザにプライベートに保存。"
full_width: true
language: "ja"
---
<style>
...
<h1 class="vp-title">細胞分裂</h1>
<p class="vp-desc">絶え間なく分裂する細胞。カラースキームを選択してください。</p>
...
<textarea id="vp-aff-input" class="vp-aff-textarea" rows="2" maxlength="300" placeholder="任意。アファメーションを入力してください。テキストは一行ずつ表示されます。"></textarea>
</div>
<div class="vp-pace">
