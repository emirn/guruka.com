---
title: "Number Crunch - 두뇌 훈련 게임"
description: "암산 능력과 인지 유연성을 단련하세요. 빠진 요소가 있는 방정식을 풀고 규칙 수정자에 대응하세요!"
full_width: true
language: "ko"
---
<style>
...
<p class="nc-subtitle">시간 압박 속에서 방정식을 풀어보세요</p>
<div id="nc-best-display" class="nc-personal-best">
개인 최고: <strong id="nc-best-score">아직 없음</strong>
</div>
<div class="nc-how-to">
<h3>플레이 방법</h3>
<ul>
<li>빠진 요소가 있는 방정식이 표시됩니다.</li>
<li>4개의 선택지에서 <strong>정답</strong>을 선택하세요.</li>
<li>레벨 6부터 <strong>규칙 수정자</strong>(예: "x2")가 등장합니다.</li>
<li>시간이 다 되기 전에 답하세요!</li>
</ul>
</div>

<button class="nc-btn-primary" id="nc-start-btn">게임 시작</button>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">점수</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">연속</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">수정자 활성</span>
</div>
...
<div class="nc-playing-hint"><strong>1-4</strong>키로 답변 · <strong>Esc</strong>키로 일시정지</div>
<button class="gk-finish-btn" id="nc-finish-btn">게임 종료</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">일시정지</div>
<button class="nc-btn-primary" id="nc-resume-btn">계속하기</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; 신기록!</div>
...
<div class="nc-complete-stat-label">도달 레벨</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">정확도</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">최고 연속</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">개인 최고</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">다시하기</button>
<a href="/ko/games/" class="nc-back-link">&larr; 모든 게임</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="nc-share-btn">&#128279; 결과 공유</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">링크가 복사되었습니다!</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: '×2', apply: function(n) { return n * 2; } },
{ name: '+10', apply: function(n) { return n + 10; } },
{ name: '-5', apply: function(n) { return n - 5; } },
{ name: '÷2', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', 그다음 ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = '수정자 활성';
} else {
...
showConfetti();
trophy.textContent = '\uD83C\uDF89';
title.textContent = '대단해요!';
elNewBest.className = 'nc-new-best-enhanced';
elNewBest.innerHTML = 'uD83CuDF1F 대단해요!신기록!';
elNewBest.style.display = 'inline-block';
} else {
trophy.textContent = '\uD83C\uDFC6';
title.textContent = '수고하셨습니다!';
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: '방정식을 풀어보세요', desc: '답이 빠진 방정식이 표시됩니다. 정답을 선택하세요!'},
{icon: '\u2728', title: '수정자에 주의', desc: '레벨 6부터 규칙 수정자가 답을 바꿉니다 (예: "×2").'},
{icon: '\u26A1', title: '빠르게!', desc: '시간이 다 되기 전에 답하세요. 빠르면 보너스 포인트!', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/ko/games/number-crunch/', 'nc-share-copied');
});
