---
title: "Speed Match - 두뇌 훈련 게임"
description: "빠른 심볼 매칭 게임으로 처리 속도와 작업 기억력을 테스트하세요. 심볼을 비교하고 빠르게 반응하세요!"
full_width: true
language: "ko"
---
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">점수</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">연속</div>
...
<div class="sm-playing-kbd-hint"><strong>Esc</strong>키로 일시정지</div>
<button class="gk-finish-btn" id="sm-finish-btn">게임 종료</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">일시정지</div>
<button class="sm-btn-primary" id="sm-resume-btn">계속하기</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; 신기록!</div>
...
<div class="sm-complete-stat-label">도달 레벨</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">정확도</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">최고 연속</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">개인 최고</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">다시하기</button>
<a href="/ko/games/" class="sm-back-link">&larr; 모든 게임</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="sm-share-btn">&#128279; 결과 공유</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">링크가 복사되었습니다!</div>
</div>
</div>
</div>
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: '심볼이 화면에 나타납니다', desc: '매 라운드마다 심볼이 표시됩니다. 잘 보세요!'},
{icon: '\u2194\uFE0F', title: '같음? 다름?', desc: '이전 심볼과 같나요? 탭해서 답하세요.'},
{icon: '\u26A1', title: '빠르게!', desc: '시간이 다 되기 전에 반응하세요. 빠르면 보너스 포인트!', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/ko/games/speed-match/', 'sm-share-copied');
});
