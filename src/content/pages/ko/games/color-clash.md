---
title: "Color Clash - 두뇌 훈련 게임"
description: "스트룹 효과를 이용해 억제 통제와 선택적 주의력을 단련하세요. 색을 식별하고 자동적인 단어 읽기를 억제하세요!"
full_width: true
language: "ko"
---
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">점수</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">연속</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">규칙 전환</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">잉크 색을 탭하세요</div>
...
<div class="cc-playing-hint"><strong>1-4</strong>키로 답변 · <strong>Esc</strong>키로 일시정지</div>
<button class="gk-finish-btn" id="cc-finish-btn">게임 종료</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">일시정지</div>
<button class="cc-btn-primary" id="cc-resume-btn">계속하기</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; 신기록!</div>
...
<div class="cc-complete-stat-label">도달 레벨</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">정확도</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">최고 연속</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">개인 최고</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">다시하기</button>
<a href="/ko/games/" class="cc-back-link">&larr; 모든 게임</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="cc-share-btn">&#128279; 결과 공유</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">링크가 복사되었습니다!</div>
</div>
</div>
</div>
...
elModifierBadge.textContent = '트리플 Stroop';
} else if (doesRuleSwitchMidLevel(state.level)) {
elModifierBadge.textContent = '레벨 내 전환';
} else {
elModifierBadge.textContent = '규칙 전환';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: '색을 읽고, 단어를 읽지 마세요', desc: '색 이름이 다른 잉크 색으로 표시됩니다. 규칙 표시기에 따라 정답을 선택하세요!'},
{icon: '\uD83D\uDD04', title: '레벨업으로 규칙이 바뀝니다', desc: '높은 레벨에서는 "잉크 색"과 "단어 의미" 규칙이 전환됩니다. 방심하지 마세요!'},
...
GK.shareResult(state.score, 'Color Clash', '/ko/games/color-clash/', 'cc-share-copied');
});
