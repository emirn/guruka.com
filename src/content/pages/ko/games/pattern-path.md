---
title: "Pattern Path - 두뇌 훈련 게임"
description: "패턴 인식과 유동 지능을 단련하세요. 형태, 색상, 변환으로 구성된 시각적 시퀀스에서 빠진 요소를 찾아보세요!"
full_width: true
language: "ko"
---
...
<p class="pp-subtitle">패턴을 찾고, 빠진 조각을 맞추세요</p>
<div id="pp-best-display" class="pp-personal-best">
개인 최고: <strong id="pp-best-score">아직 없음</strong>
</div>
<div class="pp-how-to">
<h3>플레이 방법</h3>
<ul>
<li>도형 시퀀스에 <strong>빠진 요소</strong>(?)가 표시됩니다.</li>
<li>패턴을 찾아보세요 (색상, 도형, 크기, 회전의 변화).</li>
<li>4개의 선택지에서 <strong>올바른 보완</strong>을 선택하세요.</li>
<li>시간이 다 되기 전에 답하세요!</li>
</ul>
</div>

<button class="pp-btn-primary" id="pp-start-btn">게임 시작</button>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">점수</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">연속</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">색상</span>
</div>
...
<div class="pp-playing-hint"><strong>1-4</strong>키로 답변 &middot; <strong>Esc</strong>키로 일시정지</div>
<button class="gk-finish-btn" id="pp-finish-btn">게임 종료</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">일시정지/div>
<button class="pp-btn-primary" id="pp-resume-btn">계속하기</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; 신기록!</div>
...
<div class="pp-complete-stat-label">도달 레벨/div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">정확도/div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">최고 연속/div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">개인 최고/div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">다시하기</button>
<a href="/ko/games/" class="pp-back-link">&larr; 모든 게임</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="pp-share-btn">&#128279; 결과 공유</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">링크가 복사되었습니다!</div>
</div>
</div>
</div>
...
if (lvl <= 3) return '색상';
if (lvl <= 6) return '도형';
if (lvl <= 9) return '색상 + 도형';
if (lvl <= 12) return '회전';
if (lvl <= 16) return '크기 + 수';
return '다중 속성';
}
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: '빠진 패턴을 찾아보세요', desc: '도형 시퀀스에 빠진 요소가 표시됩니다. 패턴을 찾아보세요!'},
{icon: '\uD83C\uDFA8', title: '속성이 변합니다', desc: '패턴에는 색상, 도형, 크기, 회전이 포함됩니다. 높은 레벨에서는 여러 속성이 조합됩니다.'},
{icon: '\u26A1', title: '빠르게 답하세요!', desc: '시간이 다 되기 전에 올바른 도형을 선택하세요. 빠른 답변과 연속 정답으로 보너스 포인트를 획득할 수 있습니다!', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/ko/games/pattern-path/', 'pp-share-copied');
});
