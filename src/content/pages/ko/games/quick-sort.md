---
title: "Quick Sort - 두뇌 훈련 게임"
description: "카테고리 분류 속도와 작업 전환을 단련하세요. 몇 라운드마다 규칙이 바뀌는 가운데 아이템을 올바른 카테고리로 분류하세요!"
full_width: true
language: "ko"
---
<style>
...
<div class="qs-header">
<div class="qs-stat">
<div class="qs-stat-label">점수</div>
<div class="qs-stat-value" id="qs-score">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">연속</div>
...
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">규칙 전환</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">분류: 짝수 / 홀수</div>
...
<span class="qs-label" id="qs-label-left">짝수</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">홀수</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint"><strong>A / &#8592;</strong>키로 왼쪽 &middot; <strong>D / &#8594;</strong>키로 오른쪽 &middot; <strong>Esc</strong>키로 일시정지</div>
<button class="gk-finish-btn" id="qs-finish-btn">게임 종료</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">일시정지/div>
<button class="qs-btn-primary" id="qs-resume-btn">계속하기</button>
</div>
...
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; 신기록!</div>
...
<div class="qs-complete-stat-label">도달 레벨/div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">정확도/div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">최고 연속/div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">개인 최고/div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">다시하기</button>
<a href="/ko/games/" class="qs-back-link">&larr; 모든 게임</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="qs-share-btn">&#128279; 결과 공유</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">링크가 복사되었습니다!</div>
</div>
</div>
</div>

<div class="qs-level-up-toast" id="qs-level-toast">Level Up!</div>
<div class="qs-rule-toast" id="qs-rule-toast">새 규칙!</div>
...
elRuleIndicator.textContent = '분류: ' + state.currentRule.name;
...
elRuleToast.textContent = '새 규칙: ' + ruleName;
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: '아이템을 빠르게 분류', desc: '아이템이 화면에 표시됩니다. 올바른 카테고리(왼쪽 또는 오른쪽)를 탭하여 분류하세요!'},
{icon: '\uD83D\uDD00', title: '규칙이 바뀝니다!', desc: '몇 라운드마다 분류 규칙이 전환됩니다. 방심하지 말고 빠르게 대응하세요!'},
{icon: '\u26A1', title: '빠르게 답하세요!', desc: '시간이 다 되기 전에 답하세요. 빠른 답변과 연속 정답으로 보너스 포인트를 획득할 수 있습니다!', final: true}
];
var qsWizardStep = 0;
...
GK.shareResult(state.score, 'Quick Sort', '/ko/games/quick-sort/', 'qs-share-copied');
});
