---
title: "Champ d'Étoiles - Visuel avec Affirmations"
description: "Étoiles scintillantes dérivant dans l'espace profond. Ajoutez votre propre texte d'affirmation, stocké en privé dans votre navigateur."
full_width: true
language: "fr"
---
<style>
...
<h1 class="vp-title">Champ d'Étoiles</h1>
<p class="vp-desc">Étoiles scintillantes dans l'espace profond.</p>
...
<textarea id="vp-aff-input" class="vp-aff-textarea" rows="2" maxlength="300" placeholder="optionnel. Entrez vos affirmations ici. Le texte s'affichera ligne par ligne."></textarea>
</div>
<div class="vp-pace">
