---
title: "Speed Match - Jeu d'Entraînement Cérébral"
description: "Testez votre vitesse de traitement et votre mémoire de travail avec ce jeu rapide de correspondance de symboles. Comparez les symboles et répondez rapidement !"
full_width: true
language: "fr"
---
...
<h2>Speed Match</h2>
<p class="sm-subtitle">À quelle vitesse pouvez-vous traiter ?</p>
<div class="sm-how-to">
<h3>Comment Jouer</h3>
<ol>
<li>Un symbole apparaît à l'écran à chaque manche.</li>
<li>Décidez s'il <strong>correspond</strong> au symbole de la manche précédente.</li>
<li>Cliquez sur <strong>Identique</strong> s'il correspond, <strong>Différent</strong> sinon.</li>
<li>Répondez avant la fin du temps imparti ou cela compte comme faux !</li>
<li>En montant de niveau, le jeu devient plus rapide et plus difficile.</li>
</ol>
</div>
<div class="sm-kbd-hints">
<span class="sm-kbd-hint"><span class="sm-kbd">A</span> / <span class="sm-kbd">&larr;</span> Différent</span>
<span class="sm-kbd-hint"><span class="sm-kbd">D</span> / <span class="sm-kbd">&rarr;</span> Identique</span>
...
Meilleur Score : <strong id="sm-best-score">0</strong> points
</div>
<button class="sm-btn-primary" id="sm-start-btn">Commencer</button>
<div id="sm-challenge-banner-wrap"></div>
<input type="text" id="sm-player-name" class="gk-name-input" placeholder="Votre nom (pour partager)" maxlength="20">
</div>
...
<div class="sm-stat">
<div class="sm-stat-label">Série</div>
<div class="sm-stat-value" id="sm-streak">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Niveau</div>
<div class="sm-stat-value" id="sm-level">1</div>
</div>
</div>
<div class="sm-level-info">
<span class="sm-level-text">Niveau <span id="sm-level-text">1</span></span>
...
<div class="sm-playing-kbd-hint">Appuyez sur <strong>Esc</strong> pour mettre en pause</div>
<button class="gk-finish-btn" id="sm-finish-btn">Terminer</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">En Pause</div>
<button class="sm-btn-primary" id="sm-resume-btn">Reprendre</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; Nouveau Record !</div>
...
<div class="sm-complete-stat-label">Niveau Atteint</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Précision</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Meilleure Série</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Meilleur Score</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">Rejouer</button>
<a href="/fr/games/" class="sm-back-link">&larr; Tous les Jeux</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Défier un Ami</div>
<button class="gk-share-btn" id="sm-share-btn">&#128279; Partager votre Score</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">Lien copié !</div>
</div>
</div>
</div>

<div class="sm-level-up-toast" id="sm-level-toast">Niveau Supérieur !</div>
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'Un symbole apparaît à l\'écran', desc: 'Chaque manche affiche un symbole. Observez-le !'},
{icon: '\u2194\uFE0F', title: 'Identique ou Différent ?', desc: 'Correspond-il au précédent ? Appuyez pour répondre.'},
{icon: '\u26A1', title: 'Soyez rapide !', desc: 'Réagissez avant la fin du temps. Vitesse = points bonus !', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/fr/games/speed-match/', 'sm-share-copied');
});
