---
title: "Quick Sort - Jeu d'Entra&icirc;nement C&eacute;r&eacute;bral"
description: "Entra&icirc;nez votre vitesse de cat&eacute;gorisation et votre changement de t&acirc;che. Triez les &eacute;l&eacute;ments dans la bonne cat&eacute;gorie pendant que les r&egrave;gles changent toutes les quelques manches !"
full_width: true
language: "fr"
---
...
<h2>Quick Sort</h2>
<p class="qs-subtitle">Vitesse de cat&eacute;gorisation et changement de t&acirc;che</p>
<div class="qs-how-to">
<h3>Comment Jouer</h3>
<ol>
<li>Un &eacute;l&eacute;ment (nombre, forme ou mot) appara&icirc;t &agrave; l'&eacute;cran.</li>
<li>Deux cat&eacute;gories sont affich&eacute;es &agrave; <strong>gauche et &agrave; droite</strong>.</li>
<li>Appuyez sur le bon c&ocirc;t&eacute; pour trier l'&eacute;l&eacute;ment.</li>
<li>La r&egrave;gle de tri <strong>change</strong> toutes les quelques manches !</li>
...
Record Personnel : <strong id="qs-best-score">0</strong> points
</div>
<button class="qs-btn-primary" id="qs-start-btn">Commencer</button>
<div id="qs-challenge-banner-wrap"></div>
<input type="text" id="qs-player-name" class="gk-name-input" placeholder="Votre nom (pour partager)" maxlength="20">
</div>
...
<div class="qs-stat">
<div class="qs-stat-label">S&eacute;rie</div>
<div class="qs-stat-value" id="qs-streak">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Niveau</div>
<div class="qs-stat-value" id="qs-level">1</div>
</div>
</div>
<div class="qs-level-info">
<span class="qs-level-text">Niveau <span id="qs-level-text">1</span></span>
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">Changement de r&egrave;gle</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">Trier : Pair / Impair</div>
...
<span class="qs-label" id="qs-label-left">Pair</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">Impair</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint">Appuyez sur <strong>A / &#8592;</strong> pour gauche &middot; <strong>D / &#8594;</strong> pour droite &middot; <strong>&Eacute;chap</strong> pour pause</div>
<button class="gk-finish-btn" id="qs-finish-btn">Terminer</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">Pause</div>
<button class="qs-btn-primary" id="qs-resume-btn">Reprendre</button>
</div>
...
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; Nouveau record !</div>
...
<div class="qs-complete-stat-label">Niveau atteint</div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Pr&eacute;cision</div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Meilleure s&eacute;rie</div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Record personnel</div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">Rejouer</button>
<a href="/fr/games/" class="qs-back-link">&larr; Tous les jeux</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">D&eacute;fie un ami</div>
<button class="gk-share-btn" id="qs-share-btn">&#128279; Partage ton score</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">Lien copi&eacute; !</div>
</div>
</div>
</div>

<div class="qs-level-up-toast" id="qs-level-toast">Niveau sup&eacute;rieur !</div>
<div class="qs-rule-toast" id="qs-rule-toast">Nouvelle r&egrave;gle !</div>
...
/* ── Rule definitions ── */
var SHAPES = ['Cercle', 'Carr\u00e9', 'Triangle'];
var FRUITS = ['Pomme', 'Banane', 'Cerise'];
var NOT_FRUITS = ['Voiture', 'Livre', 'Bureau'];
...
return {
name: 'Forme / Pas Forme',
leftLabel: 'Forme',
rightLabel: 'Pas Forme',
generate: function() {
...
return {
name: 'Fruit / Pas Fruit',
leftLabel: 'Fruit',
rightLabel: 'Pas Fruit',
generate: function() {
...
return {
name: 'Pair ET Grand / Autre',
leftLabel: 'Pair+Grand',
rightLabel: 'Autre',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Impair ET Petit / Autre',
leftLabel: 'Impair+Petit',
rightLabel: 'Autre',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Fruit OU Grand / Autre',
leftLabel: 'Fruit/Grand',
rightLabel: 'Autre',
generate: function() {
...
return {
name: 'Forme OU Pair / Autre',
leftLabel: 'Forme/Pair',
rightLabel: 'Autre',
generate: function() {
...
elRuleBadge.textContent = 'R\u00e8gles alternent';
} else {
...
elRuleIndicator.textContent = 'Trier : ' + state.currentRule.name;
...
elLevelToast.textContent = 'Niveau ' + level + ' !';
...
elRuleToast.textContent = 'Nouvelle r\u00e8gle : ' + ruleName;
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: 'Triez les \u00e9l\u00e9ments vite', desc: 'Un \u00e9l\u00e9ment appara\u00eet \u00e0 l\u2019\u00e9cran. Appuyez sur la bonne cat\u00e9gorie (gauche ou droite) pour le trier !'},
{icon: '\uD83D\uDD00', title: 'Les r\u00e8gles changent !', desc: 'Toutes les quelques manches, la r\u00e8gle de tri change. Restez attentif et adaptez-vous vite !'},
...
GK.shareResult(state.score, 'Quick Sort', '/fr/games/quick-sort/', 'qs-share-copied');
});
