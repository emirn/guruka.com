---
title: "Pattern Path - Jeu d'Entra\u00eenement C\u00e9r\u00e9bral"
description: "Entra\u00eenez votre reconnaissance de motifs et votre intelligence fluide. Identifiez l'\u00e9l\u00e9ment manquant dans des s\u00e9quences visuelles de formes, couleurs et transformations !"
full_width: true
language: "fr"
---
...
<input type="text" id="pp-player-name" class="gk-name-input" placeholder="Votre nom (pour partager)" maxlength="20">
</div>
...
<div class="pp-stat">
<div class="pp-stat-label">S&eacute;rie</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">Couleurs</span>
</div>
...
<div class="pp-playing-hint">Appuyez sur <strong>1-4</strong> pour r&eacute;pondre &middot; <strong>&Eacute;chap</strong> pour pause</div>
<button class="gk-finish-btn" id="pp-finish-btn">Terminer</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">Pause</div>
<button class="pp-btn-primary" id="pp-resume-btn">Reprendre</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; Nouveau record !</div>
...
<div class="pp-complete-stat-label">Niveau atteint</div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Pr&eacute;cision</div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Meilleure s&eacute;rie</div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Record personnel</div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">Rejouer</button>
<a href="/fr/games/" class="pp-back-link">&larr; Tous les jeux</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">D&eacute;fie un ami</div>
<button class="gk-share-btn" id="pp-share-btn">&#128279; Partage ton score</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">Lien copi&eacute; !</div>
</div>
</div>
</div>
...
if (lvl <= 3) return 'Couleurs';
if (lvl <= 6) return 'Formes';
if (lvl <= 9) return 'Couleur + Forme';
if (lvl <= 12) return 'Rotation';
if (lvl <= 16) return 'Taille + Quantit\u00e9';
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: 'Trouvez le motif manquant', desc: 'Une s\u00e9quence de formes appara\u00eet avec un \u00e9l\u00e9ment manquant. Identifiez le motif !'},
{icon: '\uD83C\uDFA8', title: 'Les attributs changent', desc: 'Les motifs impliquent couleur, forme, taille et rotation. Les niveaux sup\u00e9rieurs combinent plusieurs attributs.'},
{icon: '\u26A1', title: 'Soyez rapide !', desc: 'Choisissez la bonne forme avant la fin du temps. La vitesse et les s\u00e9ries rapportent des points bonus !', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/fr/games/pattern-path/', 'pp-share-copied');
});
