...
<h3>Speed Match</h3>
<p>Aumente sua velocidade de processamento com combinacao rapida de simbolos</p>
</a>
<a href="/pt/games/memory-matrix/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;">&#9638;</div>
<h3>Memory Matrix</h3>
<p>Fortaleca sua memoria espacial memorizando padroes em grade</p>
</a>
<a href="/pt/games/sequence-recall/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(16,185,129,0.1); color: #10b981;">&#9776;</div>
<h3>Sequence Recall</h3>
<p>Treine sua memoria de trabalho com sequencias de dupla trilha</p>
</a>
<a href="/pt/games/number-crunch/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(99,102,241,0.1); color: #6366f1;">&#129518;</div>
<h3>Number Crunch</h3>
<p>Aguce seu calculo mental com equacoes cronometradas e modificadores de regras</p>
</a>
<a href="/pt/games/color-clash/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(236,72,153,0.1); color: #ec4899;">&#127912;</div>
<h3>Color Clash</h3>
<p>Fortaleca o controle inibitorio com tarefas de cor baseadas em Stroop</p>
</a>
<a href="/pt/games/quick-sort/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(249,115,22,0.1); color: #f97316;">&#128451;</div>
<h3>Quick Sort</h3>
<p>Melhore a alternancia de tarefas classificando com regras mutaveis</p>
</a>
<a href="/pt/games/pattern-path/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(20,184,166,0.1); color: #14b8a6;">&#129513;</div>
<h3>Pattern Path</h3>
<p>Desenvolva reconhecimento de padroes com quebra-cabecas de sequencias visuais</p>
</a>
</div>
</div>
</div>
