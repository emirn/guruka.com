---
title: "Speed Match - Jogo de Treinamento Cerebral"
description: "Teste sua velocidade de processamento e memoria de trabalho com este jogo rapido de combinacao de simbolos. Compare simbolos e reaja rapido!"
full_width: true
language: "pt"
---
...
<h2>Speed Match</h2>
<p class="sm-subtitle">Quao rapido voce consegue processar?</p>
<div class="sm-how-to">
<h3>Como Jogar</h3>
<ol>
<li>A cada rodada, um simbolo aparece na tela.</li>
<li>Decida se ele <strong>corresponde</strong> ao simbolo da rodada anterior.</li>
<li>Clique em <strong>Igual</strong> se corresponder, <strong>Diferente</strong> se nao.</li>
<li>Responda antes que o tempo acabe, ou conta como erro!</li>
<li>Conforme voce sobe de nivel, o jogo fica mais rapido e dificil.</li>
</ol>
</div>
...
Recorde Pessoal: <strong id="sm-best-score">0</strong> Pontos
</div>
<button class="sm-btn-primary" id="sm-start-btn">Iniciar Jogo</button>
<div id="sm-challenge-banner-wrap"></div>
<input type="text" id="sm-player-name" class="gk-name-input" placeholder="Seu nome (para compartilhar)" maxlength="20">
</div>
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">Pontos</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Sequencia</div>
...
<div class="sm-playing-kbd-hint">Pressione <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="sm-finish-btn">Encerrar Jogo</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; Novo Recorde!</div>
...
<div class="sm-complete-stat-label">Nivel Alcancado</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Precisao</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Melhor Sequencia</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Recorde Pessoal</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">Jogar Novamente</button>
<a href="/pt/games/" class="sm-back-link">&larr; Todos os Jogos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Desafie um amigo</div>
<button class="gk-share-btn" id="sm-share-btn">&#128279; Compartilhar resultado</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">Link copiado!</div>
</div>
</div>
</div>
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'Um simbolo aparece na tela', desc: 'Cada rodada mostra um simbolo. Observe!'},
{icon: '\u2194\uFE0F', title: 'Igual ou Diferente?', desc: 'Corresponde ao anterior? Toque para responder.'},
...
GK.shareResult(state.score, 'Speed Match', '/pt/games/speed-match/', 'sm-share-copied');
});
