---
title: "Number Crunch - Jogo de Treinamento Cerebral"
description: "Aguce suas habilidades de calculo mental e flexibilidade cognitiva. Resolva equacoes com elementos faltantes e adapte-se aos modificadores de regras!"
full_width: true
language: "pt"
---
...
<h2>Number Crunch</h2>
<p class="nc-subtitle">Calculo mental encontra flexibilidade cognitiva</p>
<div class="nc-how-to">
<h3>Como Jogar</h3>
<ol>
<li>Uma equacao com um elemento faltante aparece.</li>
<li>Escolha a <strong>resposta correta</strong> entre 4 opcoes.</li>
<li>A partir do nivel 6 aparecem <strong>modificadores de regras</strong> (ex.: "Dobre").</li>
...
Recorde Pessoal: <strong id="nc-best-score">0</strong> Pontos
</div>
<button class="nc-btn-primary" id="nc-start-btn">Iniciar Jogo</button>
<div id="nc-challenge-banner-wrap"></div>
<input type="text" id="nc-player-name" class="gk-name-input" placeholder="Seu nome (para compartilhar)" maxlength="20">
</div>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">Pontos</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">Sequencia</div>
<div class="nc-stat-value" id="nc-streak">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">Nivel</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">Modificadores ativos</span>
</div>
...
<div class="nc-playing-hint">Dr&uuml;cke <strong>1-4</strong> zum Antworten &middot; <strong>Esc</strong> zum Pausieren</div>
<button class="gk-finish-btn" id="nc-finish-btn">Encerrar Jogo</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">Pausado</div>
<button class="nc-btn-primary" id="nc-resume-btn">Continuar</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; Novo Recorde!</div>
...
<div class="nc-complete-stat-label">Nivel Alcancado</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Precisao</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Melhor Sequencia</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Recorde Pessoal</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">Jogar Novamente</button>
<a href="/pt/games/" class="nc-back-link">&larr; Todos os Jogos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Desafie um amigo</div>
<button class="gk-share-btn" id="nc-share-btn">&#128279; Compartilhar resultado</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">Link copiado!</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: 'Dobre', apply: function(n) { return n * 2; } },
{ name: 'Some 10', apply: function(n) { return n + 10; } },
{ name: 'Subtraia 5', apply: function(n) { return n - 5; } },
{ name: 'Divida pela metade', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', depois ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'Modificadores ativos';
} else {
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: 'Resolva a equacao', desc: 'Uma equacao com resposta faltante aparece. Escolha a correta!'},
{icon: '\u2728', title: 'Atencao aos modificadores', desc: 'A partir do nivel 6, modificadores de regras alteram a resposta (ex.: "Dobre").'},
{icon: '\u26A1', title: 'Seja rapido!', desc: 'Responda antes que o tempo acabe. Velocidade = pontos bonus!', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/pt/games/number-crunch/', 'nc-share-copied');
});
