---
title: "Pattern Path - Jogo de Treinamento Cerebral"
description: "Treine seu reconhecimento de padroes e inteligencia fluida. Identifique o elemento que falta em sequencias visuais de formas, cores e transformacoes!"
full_width: true
language: "pt"
---
...
<h2>Pattern Path</h2>
<p class="pp-subtitle">Reconhecimento visual de padroes e inteligencia fluida</p>
<div class="pp-how-to">
<h3>Como Jogar</h3>
<ol>
<li>Uma sequencia de formas com um <strong>elemento faltante</strong> (?) aparece.</li>
<li>Identifique o padrao (mudancas de cor, forma, tamanho ou rotacao).</li>
<li>Escolha o <strong>complemento correto</strong> entre 4 opcoes.</li>
...
Recorde Pessoal: <strong id="pp-best-score">0</strong> Pontos
</div>
<button class="pp-btn-primary" id="pp-start-btn">Iniciar Jogo</button>
<div id="pp-challenge-banner-wrap"></div>
<input type="text" id="pp-player-name" class="gk-name-input" placeholder="Seu nome (para compartilhar)" maxlength="20">
</div>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">Pontos</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">Sequencia</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">Cores</span>
</div>
...
<div class="pp-playing-hint">Dr&uuml;cke <strong>1-4</strong> zum Antworten &middot; <strong>Esc</strong> zum Pausieren</div>
<button class="gk-finish-btn" id="pp-finish-btn">Encerrar Jogo</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">Pausado</div>
<button class="pp-btn-primary" id="pp-resume-btn">Continuar</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; Novo Recorde!</div>
...
<div class="pp-complete-stat-label">Nivel Alcancado</div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Precisao</div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Melhor Sequencia</div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Recorde Pessoal</div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">Jogar Novamente</button>
<a href="/pt/games/" class="pp-back-link">&larr; Todos os Jogos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Desafie um amigo</div>
<button class="gk-share-btn" id="pp-share-btn">&#128279; Compartilhar resultado</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">Link copiado!</div>
</div>
</div>
</div>
...
if (lvl <= 3) return 'Cores';
if (lvl <= 6) return 'Formas';
if (lvl <= 9) return 'Cor + Forma';
if (lvl <= 12) return 'Rotacao';
if (lvl <= 16) return 'Tamanho + Quantidade';
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: 'Encontre o padrao que falta', desc: 'Uma sequencia de formas aparece com um elemento faltante. Identifique o padrao!'},
{icon: '\uD83C\uDFA8', title: 'Os atributos mudam', desc: 'Padroes incluem cor, forma, tamanho e rotacao. Niveis mais altos combinam multiplos atributos.'},
{icon: '\u26A1', title: 'Seja rapido!', desc: 'Escolha a forma correta antes que o tempo acabe. Velocidade e sequencias dao pontos bonus!', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/pt/games/pattern-path/', 'pp-share-copied');
});
