---
title: "Quick Sort - Jogo de Treinamento Cerebral"
description: "Treine sua velocidade de categorizacao e alternancia de tarefas. Classifique elementos na categoria correta quando as regras mudam a cada poucas rodadas!"
full_width: true
language: "pt"
---
...
<h2>Quick Sort</h2>
<p class="qs-subtitle">Velocidade de categorizacao e alternancia de tarefas</p>
<div class="qs-how-to">
<h3>Como Jogar</h3>
<ol>
<li>Um elemento (numero, forma ou palavra) aparece na tela.</li>
<li>Duas categorias sao mostradas <strong>a esquerda e a direita</strong>.</li>
<li>Toque no lado correto para classificar o elemento.</li>
<li>A regra de classificacao <strong>muda</strong> a cada poucas rodadas!</li>
<li>Velocidade e sequencias dao pontos bonus.</li>
</ol>
</div>
<div id="qs-best-display" class="qs-personal-best" style="display:none;">
Recorde Pessoal: <strong id="qs-best-score">0</strong> Pontos
</div>
<button class="qs-btn-primary" id="qs-start-btn">Iniciar Jogo</button>
<div id="qs-challenge-banner-wrap"></div>
<input type="text" id="qs-player-name" class="gk-name-input" placeholder="Seu nome (para compartilhar)" maxlength="20">
</div>
...
<div class="qs-header">
<div class="qs-stat">
<div class="qs-stat-label">Pontos</div>
<div class="qs-stat-value" id="qs-score">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Sequencia</div>
...
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">Troca de Regra</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">Classifique: Par / Impar</div>
...
<div class="qs-playing-hint">Pressione <strong>A / &#8592;</strong> para esquerda &middot; <strong>D / &#8594;</strong> para direita &middot; <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="qs-finish-btn">Encerrar Jogo</button>
</div>
...
<h2>Jogo Concluido!</h2>
<div class="qs-final-score" id="qs-final-score">0</div>
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; Novo Recorde!</div>
...
<div class="qs-complete-stat-label">Nivel Alcancado</div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Precisao</div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Melhor Sequencia</div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Recorde Pessoal</div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">Jogar Novamente</button>
<a href="/pt/games/" class="qs-back-link">&larr; Todos os Jogos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Desafie um amigo</div>
<button class="gk-share-btn" id="qs-share-btn">&#128279; Compartilhar resultado</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">Link copiado!</div>
</div>
</div>
</div>
...
/* ── Rule definitions ── */
var SHAPES = ['Circulo', 'Quadrado', 'Triangulo'];
var FRUITS = ['Maca', 'Banana', 'Cereja'];
var NOT_FRUITS = ['Carro', 'Livro', 'Mesa'];
...
return {
name: 'Forma / Nao Forma',
leftLabel: 'Forma',
rightLabel: 'Nao Forma',
generate: function() {
...
return {
name: 'Fruta / Nao Fruta',
leftLabel: 'Fruta',
rightLabel: 'Nao Fruta',
generate: function() {
...
return {
name: 'Impar E Pequeno / Outros',
leftLabel: 'Impar+Pequeno',
rightLabel: 'Outros',
generate: function() {
var n = randInt(1, 100);
...
elRuleBadge.textContent = 'Regras mudam';
} else {
...
elRuleIndicator.textContent = 'Classifique: ' + state.currentRule.name;
...
elRuleToast.textContent = 'Nova regra: ' + ruleName;
...
showConfetti();
trophy.textContent = '\uD83C\uDF89';
title.textContent = 'FANTASTICO!';
elNewBest.className = 'qs-new-best-enhanced';
elNewBest.innerHTML = '\uD83C\uDF1F FANTASTICO! Novo Recorde!';
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: 'Classifique elementos rapidamente', desc: 'Um elemento aparece na tela. Toque na categoria correta (esquerda ou direita) para classifica-lo!'},
{icon: '\uD83D\uDD00', title: 'As regras mudam!', desc: 'A cada poucas rodadas a regra de classificacao muda. Fique atento e adapte-se rapidamente!'},
{icon: '\u26A1', title: 'Seja rapido!', desc: 'Responda antes que o tempo acabe. Velocidade e sequencias dao pontos bonus!', final: true}
];
var qsWizardStep = 0;
...
var btnLabel = s.final ? 'Iniciar Jogo' : 'Continuar';
...
GK.shareResult(state.score, 'Quick Sort', '/pt/games/quick-sort/', 'qs-share-copied');
});
