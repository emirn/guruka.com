...
<p class="cc-subtitle">Leia cores, ignore distrações</p>
<div id="cc-best-display" class="cc-personal-best">
Recorde Pessoal: <strong id="cc-best-score">nenhum ainda</strong>
</div>
<div class="cc-how-to">
<h3>Como Jogar</h3>
<ul>
<li>Uma palavra de cor aparece em uma <strong style="color:#ec4899">cor de tinta diferente</strong>.</li>
<li>Siga o <strong>indicador de regra</strong> &mdash; toque na cor correta de acordo com a regra atual.</li>
<li>As regras alternam entre <strong style="color:#ec4899">"cor da tinta"</strong> e <strong style="color:#3b82f6">"significado da palavra"</strong> conforme voce sobe de nivel.</li>
