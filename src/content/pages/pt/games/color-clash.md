---
title: "Color Clash - Jogo de Treinamento Cerebral"
description: "Treine seu controle inibitorio e atencao seletiva com o efeito Stroop. Identifique cores e suprima a leitura automatica das palavras!"
full_width: true
language: "pt"
---
...
<h2>Color Clash</h2>
<p class="cc-subtitle">Controle inibitorio baseado em Stroop e atencao seletiva</p>
<div class="cc-how-to">
<h3>Como Jogar</h3>
<ol>
<li>Uma palavra de cor aparece em uma <strong>cor de tinta diferente</strong>.</li>
<li>Siga o <strong>indicador de regra</strong> &mdash; toque na cor correta de acordo com a regra atual.</li>
<li>As regras alternam entre <strong>"cor da tinta"</strong> e <strong>"significado da palavra"</strong> conforme voce sobe de nivel.</li>
<li>Responda antes que o tempo acabe!</li>
<li>Velocidade e sequencias dao pontos bonus.</li>
</ol>
</div>
<div id="cc-best-display" class="cc-personal-best" style="display:none;">
Recorde Pessoal: <strong id="cc-best-score">0</strong> Pontos
</div>
<button class="cc-btn-primary" id="cc-start-btn">Iniciar Jogo</button>
<div id="cc-challenge-banner-wrap"></div>
<input type="text" id="cc-player-name" class="gk-name-input" placeholder="Seu nome (para compartilhar)" maxlength="20">
</div>
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">Pontos</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">Sequencia</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">Troca de Regra</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">Tippe auf die TINTENFARBE</div>
...
<div class="cc-playing-hint">Dr&uuml;cke <strong>1-4</strong> zum Antworten &middot; <strong>Esc</strong> zum Pausieren</div>
<button class="gk-finish-btn" id="cc-finish-btn">Encerrar Jogo</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">Pausado</div>
<button class="cc-btn-primary" id="cc-resume-btn">Continuar</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; Novo Recorde!</div>
...
<div class="cc-complete-stat-label">Nivel Alcancado</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Precisao</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Melhor Sequencia</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Recorde Pessoal</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">Jogar Novamente</button>
<a href="/pt/games/" class="cc-back-link">&larr; Todos os Jogos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Desafie um amigo</div>
<button class="gk-share-btn" id="cc-share-btn">&#128279; Compartilhar resultado</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">Link copiado!</div>
</div>
</div>
</div>
...
elRuleIndicator.textContent = 'Toque na COR DA TINTA';
elRuleIndicator.classList.add('cc-rule-ink');
} else if (state.currentRule === RULES.WORD) {
elRuleIndicator.textContent = 'Toque no SIGNIFICADO DA PALAVRA';
elRuleIndicator.classList.add('cc-rule-word');
} else if (state.currentRule === RULES.BG) {
elRuleIndicator.textContent = 'Toque na COR DE FUNDO';
...
elModifierBadge.textContent = 'Stroop Triplo';
} else if (doesRuleSwitchMidLevel(state.level)) {
elModifierBadge.textContent = 'Troca no nivel';
} else {
elModifierBadge.textContent = 'Troca de Regra';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: 'Leia a cor, nao a palavra', desc: 'Uma palavra de cor aparece em uma cor de tinta diferente. Siga o indicador de regra para escolher a resposta correta!'},
{icon: '\uD83D\uDD04', title: 'Regras mudam ao subir de nivel', desc: 'Em niveis mais altos, a regra alterna entre "cor da tinta" e "significado da palavra". Fique atento!'},
...
GK.shareResult(state.score, 'Color Clash', '/pt/games/color-clash/', 'cc-share-copied');
});
