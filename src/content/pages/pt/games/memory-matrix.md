...
Recorde Pessoal: <strong id="mm-best-value">nenhum ainda</strong>
</div>
<div class="mm-how-to">
<h3>Como Jogar</h3>
<ul>
<li>Observe o padr&atilde;o &mdash; celulas acendem uma a uma.</li>
<li>Memorize quais celulas acendem.</li>
<li>Toque nas mesmas celulas de mem&oacute;ria.</li>
<li>A partir do n&iacute;vel 8, <strong>a ordem importa</strong> &mdash; toque na ordem correta!</li>
</ul>
</div>

<button class="mm-btn mm-btn-primary" onclick="mmStartGame()">Iniciar Jogo</button>
...
<h2 class="mm-title">Jogo Concluido!</h2>
...
function updateInstructionsBest() {
  ...
  if (el) {
    if (best > 0) {
      el.textContent = best.toLocaleString() + ' Pontos';
    } else {
