---
title: "Células em Divisão - Visual com Afirmações"
description: "Células crescendo e dividindo-se em um ciclo meditativo. Adicione seu próprio texto de afirmação, armazenado com privacidade no navegador."
full_width: true
language: "pt"
---
<style>
...
<p class="vp-desc">Células dividindo-se sem parar.</p>
...
var paceLabels = ["Muito lento","Lento","Normal","Rápido","Muito rápido"];
var currentPace = 2;
var schemes = [
...
var affPresets = [
{title:'Nenhum',text:''},
{title:'Calma e clareza',text:'Minha mente está calma e clara\nEu solto o que não posso controlar\nEstou presente neste momento'},
{title:'Autoconfiança',text:'Acredito em mim e nas minhas capacidades\nSou digno de coisas boas\nFico mais forte a cada dia'},
{title:'Deixar ir',text:'Eu solto o que não me serve mais\nEu me perdoo e perdoo os outros\nAbro espaço para a paz'},
{title:'Gratidão',text:'Sou grato por este momento\nAbundância flui para minha vida\nApreço as coisas simples'},
{title:'Foco e energia',text:'Meu foco é firme e constante\nCanalizo minha energia com propósito\nAvanço com intenção'},
{title:'Sono e descanso',text:'Me dou permissão para descansar\nMeu corpo relaxa a cada respiração\nDeslizo para um sono tranquilo'},
{title:'Parar de fumar',text:'Meus pulmões estão mais limpos a cada dia\nSou mais forte que qualquer desejo\nCada respiração é uma vitória'}
];
