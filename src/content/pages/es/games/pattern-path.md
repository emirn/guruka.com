---
title: "Pattern Path - Juego de Entrenamiento Mental"
description: "Entrena tu reconocimiento de patrones e inteligencia fluida. Identifica el elemento faltante en secuencias visuales de formas, colores y transformaciones!"
full_width: true
language: "es"
---
...
<h2>Pattern Path</h2>
<p class="pp-subtitle">Reconocimiento visual de patrones e inteligencia fluida</p>
<div class="pp-how-to">
<h3>C&oacute;mo Jugar</h3>
<ol>
<li>Aparece una secuencia de formas con un <strong>elemento faltante</strong> (?).</li>
<li>Identifica el patr&oacute;n (cambios de color, forma, tama&ntilde;o o rotaci&oacute;n).</li>
<li>Elige la <strong>opci&oacute;n correcta</strong> entre 4 opciones.</li>
...
R&eacute;cord Personal: <strong id="pp-best-score">0</strong> puntos
</div>
<button class="pp-btn-primary" id="pp-start-btn">Iniciar Juego</button>
<div id="pp-challenge-banner-wrap"></div>
<input type="text" id="pp-player-name" class="gk-name-input" placeholder="Tu nombre (para compartir)" maxlength="20">
</div>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">Puntos</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">Racha</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">Colores</span>
</div>
...
<div class="pp-playing-hint">Pulsa <strong>1-4</strong> para responder &middot; <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="pp-finish-btn">Terminar Juego</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">Pausado</div>
<button class="pp-btn-primary" id="pp-resume-btn">Reanudar</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; &iexcl;Nuevo r&eacute;cord!</div>
...
<div class="pp-complete-stat-label">Nivel alcanzado</div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Precisi&oacute;n</div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Mejor racha</div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">R&eacute;cord personal</div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">Jugar de nuevo</button>
<a href="/es/games/" class="pp-back-link">&larr; Todos los juegos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Reta a un amigo</div>
<button class="gk-share-btn" id="pp-share-btn">&#128279; Comparte tu puntuaci&oacute;n</button>
<div class="gk-share-copied" id="pp-share-copied" style="display:none;">&iexcl;Enlace copiado!</div>
</div>
</div>
</div>
...
if (lvl <= 3) return 'Colores';
if (lvl <= 6) return 'Formas';
if (lvl <= 9) return 'Color + Forma';
if (lvl <= 12) return 'Rotaci\u00f3n';
if (lvl <= 16) return 'Tama\u00f1o + Cantidad';
return 'Multi-Atributo';
}
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: 'Encuentra el patr\u00f3n faltante', desc: 'Aparece una secuencia de formas con un elemento faltante. \u00a1Identifica el patr\u00f3n!'},
{icon: '\uD83C\uDFA8', title: 'Los atributos cambian', desc: 'Los patrones involucran color, forma, tama\u00f1o y rotaci\u00f3n. Los niveles superiores combinan m\u00faltiples atributos.'},
{icon: '\u26A1', title: '\u00a1S\u00e9 r\u00e1pido!', desc: '\u00a1Elige la forma correcta antes de que se acabe el tiempo. La velocidad y las rachas otorgan puntos extra!', final: true}
];
var ppWizardStep = 0;
...
var btnLabel = s.final ? 'Comenzar' : 'Siguiente';
...
GK.shareResult(state.score, 'Pattern Path', '/es/games/pattern-path/', 'pp-share-copied');
});
