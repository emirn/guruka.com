---
title: "Number Crunch - Juego de Entrenamiento Mental"
description: "Agudiza tu aritmética mental y flexibilidad cognitiva. ¡Resuelve ecuaciones con elementos faltantes mientras te adaptas a los modificadores de reglas!"
full_width: true
language: "es"
---
...
<p class="nc-subtitle">Resuelve ecuaciones bajo presión de tiempo</p>
<div id="nc-best-display" class="nc-personal-best">
R&eacute;cord Personal: <strong id="nc-best-score">ninguno aún</strong>
</div>
<div class="nc-how-to">
<h3>C&oacute;mo Jugar</h3>
<ul>
<li>Aparece una ecuaci&oacute;n con un elemento faltante.</li>
<li>Elige la <strong>respuesta correcta</strong> entre 4 opciones.</li>
<li>A partir del Nivel 6, aparecen <strong>modificadores de reglas</strong> (ej. &laquo;Dupl&iacute;calo&raquo;).</li>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">Puntos</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">Racha</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">Modificadores activos</span>
</div>
...
<div class="nc-playing-hint">Pulsa <strong>1-4</strong> para responder &middot; <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="nc-finish-btn">Terminar Juego</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">Pausado</div>
<button class="nc-btn-primary" id="nc-resume-btn">Reanudar</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; &iexcl;Nuevo r&eacute;cord!</div>
...
<div class="nc-complete-stat-label">Nivel alcanzado</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Precisi&oacute;n</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Mejor racha</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">R&eacute;cord personal</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">Jugar de nuevo</button>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: 'Dupl\u00edcalo', apply: function(n) { return n * 2; } },
{ name: 'Suma 10', apply: function(n) { return n + 10; } },
{ name: 'Resta 5', apply: function(n) { return n - 5; } },
{ name: 'Div\u00eddelo a la mitad', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', luego ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'Modificadores activos';
} else {
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: 'Resuelve la ecuaci\u00f3n', desc: 'Aparece una ecuaci\u00f3n con una respuesta faltante. \u00a1Elige la correcta!'},
{icon: '\u2728', title: 'Atenci\u00f3n a los modificadores', desc: 'A partir del Nivel 6, los modificadores de reglas cambian la respuesta (ej. \u00abDupl\u00edcalo\u00bb).'},
{icon: '\u26A1', title: '\u00a1S\u00e9 r\u00e1pido!', desc: '\u00a1Responde antes de que se acabe el tiempo. Velocidad = puntos extra!', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/es/games/number-crunch/', 'nc-share-copied');
});
