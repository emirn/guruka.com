...
<li data-num="1">Observa la secuencia de colores mostrada uno a la vez</li>
<li data-num="2">Memoriza el orden cuidadosamente</li>
<li data-num="3">Recuerda los colores en el mismo orden exacto</li>
<li data-num="4">Avanza a través de 20 niveles de dificultad creciente</li>
</ul>
<div class="sr-best-score" id="sr-best-display">
Mejor Puntuación: <strong id="sr-best-value">0</strong> puntos
</div>
<button class="sr-btn-primary" id="sr-start-btn">Iniciar Juego</button>
<div id="sr-challenge-banner-wrap"></div>
<input type="text" id="sr-player-name" class="gk-name-input" placeholder="Tu nombre (para compartir)" maxlength="20">
</div>
</div>
