---
title: "Quick Sort - Juego de Entrenamiento Mental"
description: "Entrena tu velocidad de categorización y cambio de tarea. ¡Ordena elementos en la categoría correcta mientras las reglas cambian cada pocas rondas!"
full_width: true
language: "es"
---
...
<h2>Quick Sort</h2>
<p class="qs-subtitle">Velocidad de categorizaci&oacute;n y cambio de tarea</p>
<div class="qs-how-to">
<h3>C&oacute;mo Jugar</h3>
<ol>
<li>Un elemento (n&uacute;mero, forma o palabra) aparece en pantalla.</li>
<li>Se muestran dos categor&iacute;as a la <strong>izquierda y derecha</strong>.</li>
<li>Toca el lado correcto para ordenar el elemento.</li>
<li>La regla de ordenaci&oacute;n <strong>cambia</strong> cada pocas rondas.</li>
<li>La velocidad y las rachas dan puntos extra.</li>
</ol>
</div>
<div id="qs-best-display" class="qs-personal-best" style="display:none;">
Mejor Puntuaci&oacute;n: <strong id="qs-best-score">0</strong> puntos
</div>
<button class="qs-btn-primary" id="qs-start-btn">Iniciar Juego</button>
<div id="qs-challenge-banner-wrap"></div>
<input type="text" id="qs-player-name" class="gk-name-input" placeholder="Tu nombre (para compartir)" maxlength="20">
</div>
...
<div class="qs-header">
<div class="qs-stat">
<div class="qs-stat-label">Puntuaci&oacute;n</div>
<div class="qs-stat-value" id="qs-score">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Racha</div>
<div class="qs-stat-value" id="qs-streak">0</div>
</div>
<div class="qs-stat">
<div class="qs-stat-label">Nivel</div>
<div class="qs-stat-value" id="qs-level">1</div>
</div>
</div>
<div class="qs-level-info">
<span class="qs-level-text">Nivel <span id="qs-level-text">1</span></span>
<span class="qs-rule-change-badge" id="qs-rule-badge" style="display:none;">Cambio de Regla</span>
</div>
...
<div class="qs-rule-indicator" id="qs-rule-indicator">Ordenar: Par / Impar</div>
...
<span class="qs-label" id="qs-label-left">Par</span>
</button>
<button class="qs-sort-btn qs-btn-right" id="qs-btn-right">
<span class="qs-label" id="qs-label-right">Impar</span>
<span class="qs-arrow">&#8594;</span>
</button>
</div>
<div class="qs-playing-hint">Presiona <strong>A / &#8592;</strong> para izquierda &middot; <strong>D / &#8594;</strong> para derecha &middot; <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="qs-finish-btn">Terminar Juego</button>
</div>

<div id="qs-pause-overlay">
<div class="qs-pause-text">Pausado</div>
<button class="qs-btn-primary" id="qs-resume-btn">Continuar</button>
</div>

<div id="qs-complete-overlay">
<div class="qs-complete-card">
<div class="qs-trophy">&#127942;</div>
<h2>&iexcl;Juego Completado!</h2>
<div class="qs-final-score" id="qs-final-score">0</div>
<div id="qs-new-best" class="qs-new-best" style="display:none;">&#11088; &iexcl;Nuevo R&eacute;cord!</div>
...
<div class="qs-complete-stat-label">Nivel Alcanzado</div>
<div class="qs-complete-stat-value" id="qs-final-level">1</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Precisi&oacute;n</div>
<div class="qs-complete-stat-value" id="qs-final-accuracy">0%</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Mejor Racha</div>
<div class="qs-complete-stat-value" id="qs-final-streak">0</div>
</div>
<div class="qs-complete-stat">
<div class="qs-complete-stat-label">Mejor Puntuaci&oacute;n</div>
<div class="qs-complete-stat-value" id="qs-final-best">0</div>
</div>
</div>
<div class="qs-complete-actions">
<button class="qs-btn-primary" id="qs-play-again-btn">Jugar de Nuevo</button>
<a href="/es/games/" class="qs-back-link">&larr; Volver a Juegos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Reta a un Amigo</div>
<button class="gk-share-btn" id="qs-share-btn">&#128279; Comparte tu Puntuaci&oacute;n</button>
<div class="gk-share-copied" id="qs-share-copied" style="display:none;">&iexcl;Enlace copiado!</div>
</div>
</div>
</div>

<div class="qs-level-up-toast" id="qs-level-toast">&iexcl;Subiste de Nivel!</div>
<div class="qs-rule-toast" id="qs-rule-toast">&iexcl;Nueva Regla!</div>
...
/* ── Rule definitions ── */
var SHAPES = ['C\u00edrculo', 'Cuadrado', 'Tri\u00e1ngulo'];
var FRUITS = ['Manzana', 'Pl\u00e1tano', 'Cereza'];
var NOT_FRUITS = ['Coche', 'Libro', 'Escritorio'];
...
return {
name: 'Par Y Grande / Otro',
leftLabel: 'Par+Grande',
rightLabel: 'Otro',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Impar Y Peque\u00f1o / Otro',
leftLabel: 'Impar+Peque\u00f1o',
rightLabel: 'Otro',
generate: function() {
var n = randInt(1, 100);
...
return {
name: 'Fruta O Grande / Otro',
leftLabel: 'Fruta/Grande',
rightLabel: 'Otro',
generate: function() {
...
elRuleBadge.textContent = 'Reglas Alternan';
} else {
...
elRuleIndicator.textContent = 'Ordenar: ' + state.currentRule.name;
...
elLevelToast.textContent = 'Nivel ' + level + '!';
...
elRuleToast.textContent = 'Nueva Regla: ' + ruleName;
...
elNewBest.innerHTML = '\uD83C\uDF1F \u00a1INCRE\u00cdBLE! \u00a1Nuevo R\u00e9cord!';
...
/* ── Start game flow ── */
var QS_WIZARD_STEPS = [
{icon: '\uD83D\uDCC2', title: 'Ordena elementos r\u00e1pido', desc: 'Un elemento aparece en pantalla. \u00a1Toca la categor\u00eda correcta (izquierda o derecha) para ordenarlo!'},
{icon: '\uD83D\uDD00', title: '\u00a1Las reglas cambian!', desc: '\u00a1Cada pocas rondas la regla de ordenaci\u00f3n cambia. Mantente atento y ad\u00e1ptate r\u00e1pido!'},
{icon: '\u26A1', title: '\u00a1S\u00e9 r\u00e1pido!', desc: '\u00a1Responde antes de que se acabe el tiempo. Velocidad y rachas dan puntos extra!', final: true}
];
var qsWizardStep = 0;
...
GK.shareResult(state.score, 'Quick Sort', '/es/games/quick-sort/', 'qs-share-copied');
});
