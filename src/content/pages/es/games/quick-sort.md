...
<p class="qs-subtitle">Ordena rápido mientras cambian las reglas</p>
<div id="qs-best-display" class="qs-personal-best">
Mejor Puntuaci&oacute;n: <strong id="qs-best-score">ninguno aún</strong>
</div>
<div class="qs-how-to">
...
var best = loadBest();
if (best > 0) {
elBestScore.textContent = best.toLocaleString() + ' puntos';
} else {
elBestScore.textContent = 'ninguno aún';
}
}
