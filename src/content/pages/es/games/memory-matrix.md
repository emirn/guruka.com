...
<h3>Cómo Jugar:</h3>
<ol>
<li><span class="mm-step-num">1</span><span>Observa el patrón -- las celdas se iluminarán una por una</span></li>
<li><span class="mm-step-num">2</span><span>Memoriza qué celdas se iluminan</span></li>
<li><span class="mm-step-num">3</span><span>Toca las mismas celdas de memoria</span></li>
<li><span class="mm-step-num">4</span><span>Desde el nivel 8, ¡el orden importa! Toca en la secuencia correcta</span></li>
</ol>
</div>
<div id="mm-instr-best" class="mm-best-banner" style="display:none;"></div>
<button class="mm-btn mm-btn-primary" onclick="mmShowWizard()">Iniciar Juego</button>
<div id="mm-challenge-banner-wrap"></div>
<input type="text" id="mm-player-name" class="gk-name-input" placeholder="Tu nombre (para compartir)" maxlength="20">
</div>
</div>
...
<h1 class="mm-title">¡Juego Completado!</h1>
...
function updateInstructionsBest() {
  ...
  if (best > 0 && banner) {
    ...
    banner.innerHTML = 'Mejor Puntuación: <strong>' + best.toLocaleString() + ' puntos</strong>';
  }
}
