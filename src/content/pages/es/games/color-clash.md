---
title: "Color Clash - Juego de Entrenamiento Mental"
description: "Entrena tu control inhibitorio y atenci&oacute;n selectiva con el efecto Stroop. &iexcl;Identifica colores mientras suprimes la lectura autom&aacute;tica de palabras!"
full_width: true
language: "es"
---
...
<h2>Color Clash</h2>
<p class="cc-subtitle">Control inhibitorio basado en Stroop &amp; atenci&oacute;n selectiva</p>
<div class="cc-how-to">
<h3>C&oacute;mo jugar</h3>
<ol>
<li>Aparece una palabra de color escrita en un <strong>color de tinta diferente</strong>.</li>
<li>Sigue el <strong>indicador de regla</strong> &mdash; toca el color correcto seg&uacute;n la regla actual.</li>
<li>Las reglas cambian entre <strong>&laquo;Color de tinta&raquo;</strong> y <strong>&laquo;Significado de la palabra&raquo;</strong> a medida que subes de nivel.</li>
<li>&iexcl;Responde antes de que se acabe el tiempo!</li>
<li>La velocidad y las rachas otorgan puntos extra.</li>
</ol>
</div>
<div id="cc-best-display" class="cc-personal-best" style="display:none;">
R&eacute;cord personal: <strong id="cc-best-score">0</strong> puntos
</div>
<button class="cc-btn-primary" id="cc-start-btn">Iniciar juego</button>
<div id="cc-challenge-banner-wrap"></div>
<input type="text" id="cc-player-name" class="gk-name-input" placeholder="Tu nombre (para compartir)" maxlength="20">
</div>
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">Puntos</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">Racha</div>
<div class="cc-stat-value" id="cc-streak">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">Nivel</div>
<div class="cc-stat-value" id="cc-level">1</div>
</div>
</div>
<div class="cc-level-info">
<span class="cc-level-text">Nivel <span id="cc-level-text">1</span></span>
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">Cambio de regla</span>
</div>
...
<div class="cc-rule-indicator cc-rule-ink" id="cc-rule-indicator">Toca el COLOR DE TINTA</div>
...
<div class="cc-playing-hint">Pulsa <strong>1-4</strong> para responder &middot; <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="cc-finish-btn">Terminar juego</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">Pausado</div>
<button class="cc-btn-primary" id="cc-resume-btn">Reanudar</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; &iexcl;Nuevo r&eacute;cord!</div>
...
<div class="cc-complete-stat-label">Nivel alcanzado</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Precisi&oacute;n</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Mejor racha</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">R&eacute;cord personal</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">Jugar de nuevo</button>
<a href="/es/games/" class="cc-back-link">&larr; Todos los juegos</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Reta a un amigo</div>
<button class="gk-share-btn" id="cc-share-btn">&#128279; Comparte tu puntuaci&oacute;n</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">&iexcl;Enlace copiado!</div>
</div>
</div>
</div>

<div class="cc-level-up-toast" id="cc-level-toast">&iexcl;Nivel arriba!</div>
...
elRuleIndicator.textContent = 'Toca el COLOR DE TINTA';
elRuleIndicator.classList.add('cc-rule-ink');
} else if (state.currentRule === RULES.WORD) {
elRuleIndicator.textContent = 'Toca el SIGNIFICADO DE LA PALABRA';
elRuleIndicator.classList.add('cc-rule-word');
} else if (state.currentRule === RULES.BG) {
elRuleIndicator.textContent = 'Toca el COLOR DE FONDO';
...
elModifierBadge.textContent = 'Cambio en nivel';
} else {
elModifierBadge.textContent = 'Cambio de regla';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: 'Lee el color, no la palabra', desc: 'Aparece una palabra de color en un color de tinta diferente. \u00a1Sigue el indicador de regla para elegir la respuesta correcta!'},
{icon: '\uD83D\uDD04', title: 'Las reglas cambian al subir de nivel', desc: 'En niveles m\u00e1s altos, la regla alterna entre \u00abColor de tinta\u00bb y \u00abSignificado de la palabra\u00bb. \u00a1Mant\u00e9n la atenci\u00f3n!'},
{icon: '\u26A1', title: '\u00a1S\u00e9 r\u00e1pido!', desc: '\u00a1Responde antes de que se acabe el tiempo. La velocidad y las rachas dan puntos extra!', final: true}
];
var ccWizardStep = 0;
...
GK.shareResult(state.score, 'Color Clash', '/es/games/color-clash/', 'cc-share-copied');
});
