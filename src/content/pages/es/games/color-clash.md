...
<p class="cc-subtitle">Lee colores, ignora distracciones</p>
<div id="cc-best-display" class="cc-personal-best">
R&eacute;cord personal: <strong id="cc-best-score">ninguno aún</strong>
</div>
<div class="cc-how-to">
<h3>C&oacute;mo jugar</h3>
<ul>
<li>Aparece una palabra de color escrita en un <strong style="color:#ec4899">color de tinta diferente</strong>.</li>
<li>Sigue el <strong>indicador de regla</strong> &mdash; toca el color correcto seg&uacute;n la regla actual.</li>
<li>Las reglas cambian entre <strong style="color:#ec4899">&laquo;Color de tinta&raquo;</strong> y <strong style="color:#3b82f6">&laquo;Significado de la palabra&raquo;</strong> a medida que subes de nivel.</li>
