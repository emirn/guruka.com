---
title: "Speed Match - Juego de Entrenamiento Cerebral"
description: "Pon a prueba tu velocidad de procesamiento y memoria de trabajo con este juego rápido de emparejamiento de símbolos. ¡Compara símbolos y responde rápidamente!"
full_width: true
language: "es"
---
...
<p class="sm-subtitle">¿Qué tan rápido puedes procesar?</p>
<div id="sm-best-display" class="sm-personal-best">
Mejor Puntuación: <strong id="sm-best-score">ninguno aún</strong>
</div>
<div class="sm-how-to">
<h3>Cómo Jugar</h3>
<ul>
<li>Un símbolo aparece en pantalla cada ronda.</li>
<li>Decide si <strong>coincide</strong> con el símbolo de la ronda anterior.</li>
<li>Haz clic en <strong>Igual</strong> si coincide, <strong>Diferente</strong> si no.</li>
<li>¡Responde antes de que se acabe el tiempo &mdash; el juego se vuelve más rápido a medida que subes de nivel!</li>
</ul>
</div>
<div class="sm-kbd-hints">
<span class="sm-kbd-hint"><span class="sm-kbd">A</span> / <span class="sm-kbd">&larr;</span> Diferente</span>
<span class="sm-kbd-hint"><span class="sm-kbd">D</span> / <span class="sm-kbd">&rarr;</span> Igual</span>
<span class="sm-kbd-hint"><span class="sm-kbd">Esc</span> Pausa</span>
</div>

<button class="sm-btn-primary" id="sm-start-btn">Iniciar Juego</button>
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">Puntuación</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Racha</div>
<div class="sm-stat-value" id="sm-streak">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Nivel</div>
<div class="sm-stat-value" id="sm-level">1</div>
</div>
</div>
<div class="sm-level-info">
<span class="sm-level-text">Nivel <span id="sm-level-text">1</span></span>
...
<div class="sm-playing-kbd-hint">Presiona <strong>Esc</strong> para pausar</div>
<button class="gk-finish-btn" id="sm-finish-btn">Terminar Juego</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">Pausado</div>
<button class="sm-btn-primary" id="sm-resume-btn">Continuar</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; ¡Nuevo Récord!</div>
...
<div class="sm-complete-stat-label">Nivel Alcanzado</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Precisión</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Mejor Racha</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Mejor Puntuación</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">Jugar de Nuevo</button>
<a href="/es/games/" class="sm-back-link">&larr; Volver a Juegos</a>
</div>
<div class="gk-share-section">

<button class="gk-share-btn" id="sm-share-btn">&#128279; Comparte tu Puntuación</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">¡Enlace copiado!</div>
</div>
</div>
</div>

<div class="sm-level-up-toast" id="sm-level-toast">¡Subiste de Nivel!</div>
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'Un símbolo aparece en pantalla', desc: 'Cada ronda muestra un símbolo. ¡Obsérvalo!'},
{icon: '\u2194\uFE0F', title: '¿Igual o Diferente?', desc: '¿Coincide con el anterior? Toca para responder.'},
{icon: '\u26A1', title: '¡Sé rápido!', desc: '¡Reacciona antes de que se acabe el tiempo. Velocidad = puntos extra!', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/es/games/speed-match/', 'sm-share-copied');
});
