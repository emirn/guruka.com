...
<li data-num="1">Beobachte die Farbfolge, die nacheinander gezeigt wird</li>
<li data-num="2">Merke dir die Reihenfolge sorgfältig</li>
<li data-num="3">Erinnere die Farben in exakt derselben Reihenfolge</li>
<li data-num="4">Durchlaufe 20 Level mit steigender Schwierigkeit</li>
</ul>
<div class="sr-best-score" id="sr-best-display">
Persönlicher Rekord: <strong id="sr-best-value">0</strong> Punkte
</div>
<button class="sr-btn-primary" id="sr-start-btn">Spiel starten</button>
<div id="sr-challenge-banner-wrap"></div>
<input type="text" id="sr-player-name" class="gk-name-input" placeholder="Dein Name (zum Teilen)" maxlength="20">
</div>
</div>
