---
title: "Speed Match - Gehirntraining Spiel"
description: "Teste deine Verarbeitungsgeschwindigkeit und dein Arbeitsgedächtnis mit diesem schnellen Symbol-Matching-Spiel. Vergleiche Symbole und reagiere schnell!"
full_width: true
language: "de"
---
...
<input type="text" id="sm-player-name" class="gk-name-input" placeholder="Dein Name (zum Teilen)" maxlength="20">
</div>
...
<div class="sm-header">
<div class="sm-stat">
<div class="sm-stat-label">Punkte</div>
<div class="sm-stat-value" id="sm-score">0</div>
</div>
<div class="sm-stat">
<div class="sm-stat-label">Serie</div>
...
<div class="sm-playing-kbd-hint">Drücke <strong>Esc</strong> zum Pausieren</div>
<button class="gk-finish-btn" id="sm-finish-btn">Spiel beenden</button>
</div>

<div id="sm-pause-overlay">
<div class="sm-pause-text">Pausiert</div>
<button class="sm-btn-primary" id="sm-resume-btn">Fortsetzen</button>
</div>
...
<div id="sm-new-best" class="sm-new-best" style="display:none;">&#11088; Neuer Rekord!</div>
...
<div class="sm-complete-stat-label">Level erreicht</div>
<div class="sm-complete-stat-value" id="sm-final-level">1</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Genauigkeit</div>
<div class="sm-complete-stat-value" id="sm-final-accuracy">0%</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Beste Serie</div>
<div class="sm-complete-stat-value" id="sm-final-streak">0</div>
</div>
<div class="sm-complete-stat">
<div class="sm-complete-stat-label">Persönlicher Rekord</div>
<div class="sm-complete-stat-value" id="sm-final-best">0</div>
</div>
</div>
<div class="sm-complete-actions">
<button class="sm-btn-primary" id="sm-play-again-btn">Nochmal spielen</button>
<a href="/de/games/" class="sm-back-link">&larr; Alle Spiele</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Fordere einen Freund heraus</div>
<button class="gk-share-btn" id="sm-share-btn">&#128279; Teile dein Ergebnis</button>
<div class="gk-share-copied" id="sm-share-copied" style="display:none;">Link kopiert!</div>
</div>
</div>
</div>
...
/* ── Start game flow ── */
var SM_WIZARD_STEPS = [
{icon: '\u2728', title: 'Ein Symbol erscheint auf dem Bildschirm', desc: 'Jede Runde zeigt ein Symbol. Beobachte es!'},
{icon: '\u2194\uFE0F', title: 'Gleich oder Anders?', desc: 'Stimmt es mit dem vorherigen überein? Tippe zum Antworten.'},
{icon: '\u26A1', title: 'Sei schnell!', desc: 'Reagiere bevor die Zeit abläuft. Geschwindigkeit = Bonuspunkte!', final: true}
];
var smWizardStep = 0;
...
GK.shareResult(state.score, 'Speed Match', '/de/games/speed-match/', 'sm-share-copied');
});
