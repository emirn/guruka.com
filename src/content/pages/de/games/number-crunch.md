---
title: "Number Crunch - Gehirntraining Spiel"
description: "Schärfe deine Kopfrechnen-Fähigkeiten und kognitive Flexibilität. Löse Gleichungen mit fehlenden Elementen und passe dich an Regelmodifikatoren an!"
full_width: true
language: "de"
---
...
<h2>Number Crunch</h2>
<p class="nc-subtitle">Kopfrechnen trifft kognitive Flexibilit&auml;t</p>
<div class="nc-how-to">
<h3>Wie man spielt</h3>
<ol>
<li>Eine Gleichung mit einem fehlenden Element erscheint.</li>
<li>W&auml;hle die <strong>richtige Antwort</strong> aus 4 M&ouml;glichkeiten.</li>
<li>Ab Level 6 erscheinen <strong>Regelmodifikatoren</strong> (z.B. &bdquo;Verdopple es&ldquo;).</li>
...
Pers&ouml;nlicher Rekord: <strong id="nc-best-score">0</strong> Punkte
</div>
<button class="nc-btn-primary" id="nc-start-btn">Spiel starten</button>
<div id="nc-challenge-banner-wrap"></div>
<input type="text" id="nc-player-name" class="gk-name-input" placeholder="Dein Name (zum Teilen)" maxlength="20">
</div>
...
<div class="nc-header">
<div class="nc-stat">
<div class="nc-stat-label">Punkte</div>
<div class="nc-stat-value" id="nc-score">0</div>
</div>
<div class="nc-stat">
<div class="nc-stat-label">Serie</div>
...
<span class="nc-modifier-badge" id="nc-modifier-badge" style="display:none;">Modifikatoren aktiv</span>
</div>
...
<button class="gk-finish-btn" id="nc-finish-btn">Spiel beenden</button>
</div>

<div id="nc-pause-overlay">
<div class="nc-pause-text">Pausiert</div>
<button class="nc-btn-primary" id="nc-resume-btn">Fortsetzen</button>
</div>
...
<div id="nc-new-best" class="nc-new-best" style="display:none;">&#11088; Neuer Rekord!</div>
...
<div class="nc-complete-stat-label">Level erreicht</div>
<div class="nc-complete-stat-value" id="nc-final-level">1</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Genauigkeit</div>
<div class="nc-complete-stat-value" id="nc-final-accuracy">0%</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Beste Serie</div>
<div class="nc-complete-stat-value" id="nc-final-streak">0</div>
</div>
<div class="nc-complete-stat">
<div class="nc-complete-stat-label">Pers&ouml;nlicher Rekord</div>
<div class="nc-complete-stat-value" id="nc-final-best">0</div>
</div>
</div>
<div class="nc-complete-actions">
<button class="nc-btn-primary" id="nc-play-again-btn">Nochmal spielen</button>
<a href="/de/games/" class="nc-back-link">&larr; Alle Spiele</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Fordere einen Freund heraus</div>
<button class="gk-share-btn" id="nc-share-btn">&#128279; Teile dein Ergebnis</button>
<div class="gk-share-copied" id="nc-share-copied" style="display:none;">Link kopiert!</div>
</div>
</div>
</div>
...
/* ── Modifiers ── */
var MODIFIERS = [
{ name: 'Verdopple es', apply: function(n) { return n * 2; } },
{ name: 'Addiere 10', apply: function(n) { return n + 10; } },
{ name: 'Subtrahiere 5', apply: function(n) { return n - 5; } },
{ name: 'Halbiere es', apply: function(n) { return Math.round(n / 2); } }
];
...
return {
name: a.name + ', dann ' + b.name.toLowerCase(),
...
elModifierBadge.textContent = 'Modifikatoren aktiv';
} else {
...
/* ── Start game flow ── */
var NC_WIZARD_STEPS = [
{icon: '\uD83E\uDDEE', title: 'L\u00f6se die Gleichung', desc: 'Eine Gleichung mit einer fehlenden Antwort erscheint. W\u00e4hle die richtige!'},
{icon: '\u2728', title: 'Achte auf Modifikatoren', desc: 'Ab Level 6 ver\u00e4ndern Regelmodifikatoren die Antwort (z.B. \u201eVerdopple es\u201c).'},
{icon: '\u26A1', title: 'Sei schnell!', desc: 'Antworte bevor die Zeit abl\u00e4uft. Geschwindigkeit = Bonuspunkte!', final: true}
];
var ncWizardStep = 0;
...
GK.shareResult(state.score, 'Number Crunch', '/de/games/number-crunch/', 'nc-share-copied');
});
