---
title: "Pattern Path - Gehirntraining Spiel"
description: "Trainiere deine Mustererkennung und fluide Intelligenz. Identifiziere das fehlende Element in visuellen Sequenzen aus Formen, Farben und Transformationen!"
full_width: true
language: "de"
---
...
<p class="pp-subtitle">Erkenne Muster, finde das fehlende Teil</p>
<div id="pp-best-display" class="pp-personal-best">
Pers&ouml;nlicher Rekord: <strong id="pp-best-score">noch keiner</strong>
</div>
<div class="pp-how-to">
<h3>Wie man spielt</h3>
<ul>
<li>Eine Sequenz von Formen mit einem <strong>fehlenden Element</strong> (?) erscheint.</li>
<li>Erkenne das Muster (Farb-, Form-, Gr&ouml;&szlig;en- oder Rotations&auml;nderungen).</li>
<li>W&auml;hle die <strong>richtige Erg&auml;nzung</strong> aus 4 M&ouml;glichkeiten.</li>
...
<div class="pp-header">
<div class="pp-stat">
<div class="pp-stat-label">Punkte</div>
<div class="pp-stat-value" id="pp-score">0</div>
</div>
<div class="pp-stat">
<div class="pp-stat-label">Serie</div>
...
<span class="pp-difficulty-badge" id="pp-difficulty-badge">Farben</span>
</div>
...
<button class="gk-finish-btn" id="pp-finish-btn">Spiel beenden</button>
</div>

<div id="pp-pause-overlay">
<div class="pp-pause-text">Pausiert</div>
<button class="pp-btn-primary" id="pp-resume-btn">Fortsetzen</button>
</div>
...
<div id="pp-new-best" class="pp-new-best" style="display:none;">&#11088; Neuer Rekord!</div>
...
<div class="pp-complete-stat-label">Level erreicht</div>
<div class="pp-complete-stat-value" id="pp-final-level">1</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Genauigkeit</div>
<div class="pp-complete-stat-value" id="pp-final-accuracy">0%</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Beste Serie</div>
<div class="pp-complete-stat-value" id="pp-final-streak">0</div>
</div>
<div class="pp-complete-stat">
<div class="pp-complete-stat-label">Pers&ouml;nlicher Rekord</div>
<div class="pp-complete-stat-value" id="pp-final-best">0</div>
</div>
</div>
<div class="pp-complete-actions">
<button class="pp-btn-primary" id="pp-play-again-btn">Nochmal spielen</button>
...
if (lvl <= 3) return 'Farben';
if (lvl <= 6) return 'Formen';
if (lvl <= 9) return 'Farbe + Form';
if (lvl <= 12) return 'Rotation';
if (lvl <= 16) return 'Gr\u00f6\u00dfe + Anzahl';
return 'Multi-Attribut';
}
...
/* ── Start game flow ── */
var PP_WIZARD_STEPS = [
{icon: '\uD83E\uDDE9', title: 'Finde das fehlende Muster', desc: 'Eine Sequenz von Formen erscheint mit einem fehlenden Element. Erkenne das Muster!'},
{icon: '\uD83C\uDFA8', title: 'Attribute \u00e4ndern sich', desc: 'Muster umfassen Farbe, Form, Gr\u00f6\u00dfe und Rotation. H\u00f6here Level kombinieren mehrere Attribute.'},
{icon: '\u26A1', title: 'Sei schnell!', desc: 'W\u00e4hle die richtige Form bevor die Zeit abl\u00e4uft. Geschwindigkeit und Serien bringen Bonuspunkte!', final: true}
];
var ppWizardStep = 0;
...
GK.shareResult(state.score, 'Pattern Path', '/de/games/pattern-path/', 'pp-share-copied');
});
