---
title: "Color Clash - Gehirntraining Spiel"
description: "Trainiere deine Hemmungskontrolle und selektive Aufmerksamkeit mit dem Stroop-Effekt. Erkenne Farben und unterdr&uuml;cke das automatische Wortlesen!"
full_width: true
language: "de"
---
...
<h2>Color Clash</h2>
<p class="cc-subtitle">Stroop-basierte Hemmungskontrolle &amp; selektive Aufmerksamkeit</p>
<div class="cc-how-to">
<h3>Wie man spielt</h3>
<ol>
<li>Ein Farbwort erscheint in einer <strong>anderen Tintenfarbe</strong>.</li>
<li>Folge dem <strong>Regelindikator</strong> &mdash; tippe auf die richtige Farbe gem&auml;&szlig; der aktuellen Regel.</li>
<li>Die Regeln wechseln zwischen <strong>&bdquo;Tintenfarbe&ldquo;</strong> und <strong>&bdquo;Wortbedeutung&ldquo;</strong> wenn du aufsteigst.</li>
<li>Antworte bevor die Zeit abl&auml;uft!</li>
<li>Geschwindigkeit und Serien bringen Bonuspunkte.</li>
</ol>
</div>
<div id="cc-best-display" class="cc-personal-best" style="display:none;">
Pers&ouml;nlicher Rekord: <strong id="cc-best-score">0</strong> Punkte
</div>
<button class="cc-btn-primary" id="cc-start-btn">Spiel starten</button>
<div id="cc-challenge-banner-wrap"></div>
<input type="text" id="cc-player-name" class="gk-name-input" placeholder="Dein Name (zum Teilen)" maxlength="20">
</div>
...
<div class="cc-header">
<div class="cc-stat">
<div class="cc-stat-label">Punkte</div>
<div class="cc-stat-value" id="cc-score">0</div>
</div>
<div class="cc-stat">
<div class="cc-stat-label">Serie</div>
...
<span class="cc-modifier-badge" id="cc-modifier-badge" style="display:none;">Regelwechsel</span>
</div>
...
<button class="gk-finish-btn" id="cc-finish-btn">Spiel beenden</button>
</div>

<div id="cc-pause-overlay">
<div class="cc-pause-text">Pausiert</div>
<button class="cc-btn-primary" id="cc-resume-btn">Fortsetzen</button>
</div>
...
<div id="cc-new-best" class="cc-new-best" style="display:none;">&#11088; Neuer Rekord!</div>
...
<div class="cc-complete-stat-label">Level erreicht</div>
<div class="cc-complete-stat-value" id="cc-final-level">1</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Genauigkeit</div>
<div class="cc-complete-stat-value" id="cc-final-accuracy">0%</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Beste Serie</div>
<div class="cc-complete-stat-value" id="cc-final-streak">0</div>
</div>
<div class="cc-complete-stat">
<div class="cc-complete-stat-label">Pers&ouml;nlicher Rekord</div>
<div class="cc-complete-stat-value" id="cc-final-best">0</div>
</div>
</div>
<div class="cc-complete-actions">
<button class="cc-btn-primary" id="cc-play-again-btn">Nochmal spielen</button>
<a href="/de/games/" class="cc-back-link">&larr; Alle Spiele</a>
</div>
<div class="gk-share-section">
<div class="gk-share-title">Fordere einen Freund heraus</div>
<button class="gk-share-btn" id="cc-share-btn">&#128279; Teile dein Ergebnis</button>
<div class="gk-share-copied" id="cc-share-copied" style="display:none;">Link kopiert!</div>
</div>
</div>
</div>
...
elRuleIndicator.textContent = 'Tippe auf die TINTENFARBE';
elRuleIndicator.classList.add('cc-rule-ink');
} else if (state.currentRule === RULES.WORD) {
elRuleIndicator.textContent = 'Tippe auf die WORTBEDEUTUNG';
elRuleIndicator.classList.add('cc-rule-word');
} else if (state.currentRule === RULES.BG) {
elRuleIndicator.textContent = 'Tippe auf die HINTERGRUNDFARBE';
...
elModifierBadge.textContent = 'Dreifach-Stroop';
} else if (doesRuleSwitchMidLevel(state.level)) {
elModifierBadge.textContent = 'Wechsel im Level';
} else {
elModifierBadge.textContent = 'Regelwechsel';
}
} else {
...
/* ── Start game flow ── */
var CC_WIZARD_STEPS = [
{icon: '\uD83C\uDFA8', title: 'Lies die Farbe, nicht das Wort', desc: 'Ein Farbwort erscheint in einer anderen Tintenfarbe. Folge dem Regelindikator, um die richtige Antwort zu w\u00e4hlen!'},
{icon: '\uD83D\uDD04', title: 'Regeln wechseln beim Aufstieg', desc: 'Auf h\u00f6heren Leveln wechselt die Regel zwischen \u201eTintenfarbe\u201c und \u201eWortbedeutung\u201c. Bleib aufmerksam!'},
...
GK.shareResult(state.score, 'Color Clash', '/de/games/color-clash/', 'cc-share-copied');
});
