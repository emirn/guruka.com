...
<div class="gk-section">
<div class="gk-section-header">
<h2>Gehirntraining-Spiele</h2>
<p>Trainiere dein Gehirn mit sieben Spielen, die verschiedene kognitive Fähigkeiten ansprechen</p>
<p class="gk-free-tag">Kostenlos und ohne nervige Werbung</p>
</div>
<div class="gk-cards">
<a href="/de/games/speed-match/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(15,144,114,0.1); color: #0f9072;">&#9889;</div>
<h3>Speed Match</h3>
<p>Steigere deine Verarbeitungsgeschwindigkeit mit rasantem Symbol-Matching</p>
</a>
<a href="/de/games/memory-matrix/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;">&#9638;</div>
<h3>Memory Matrix</h3>
<p>Stärke dein räumliches Gedächtnis durch das Erinnern von Gittermustern</p>
</a>
<a href="/de/games/sequence-recall/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(16,185,129,0.1); color: #10b981;">&#9776;</div>
<h3>Sequence Recall</h3>
<p>Trainiere dein Arbeitsgedächtnis mit zweispurigen Sequenzen</p>
</a>
<a href="/de/games/number-crunch/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(99,102,241,0.1); color: #6366f1;">&#129518;</div>
<h3>Number Crunch</h3>
<p>Schärfe dein Kopfrechnen mit zeitgesteuerten Gleichungen und Regelmodifikatoren</p>
</a>
<a href="/de/games/color-clash/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(236,72,153,0.1); color: #ec4899;">&#127912;</div>
<h3>Color Clash</h3>
<p>Stärke die inhibitorische Kontrolle mit Stroop-basierten Farbaufgaben</p>
</a>
<a href="/de/games/quick-sort/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(249,115,22,0.1); color: #f97316;">&#128451;</div>
<h3>Quick Sort</h3>
<p>Verbessere den Aufgabenwechsel durch Sortieren mit wechselnden Regeln</p>
</a>
<a href="/de/games/pattern-path/" class="gk-card">
<div class="gk-card-icon" style="background: rgba(20,184,166,0.1); color: #14b8a6;">&#129513;</div>
<h3>Pattern Path</h3>
<p>Entwickle Mustererkennung mit visuellen Sequenzrätseln</p>
</a>
</div>
</div>
</div>
...
<div class="gk-section">
<div class="gk-section-header">
<h2>Meditative Visualisierungen</h2>
<p>Beruhigende Vollbild-Animationen für Entspannung und Fokus</p>
<p class="gk-free-tag">Kostenlos und ohne nervige Werbung</p>
</div>
<div class="gk-med-cards">
<a href="/de/visuals/breathing-orb/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #6366f1, #a78bfa);"></div>
<span>Atemkugel</span>
</a>
<a href="/de/visuals/aurora/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #22d3ee, #06b6d4);"></div>
<span>Aurora</span>
</a>
<a href="/de/visuals/starfield/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #1e293b, #475569);"></div>
<span>Sternenfeld</span>
</a>
<a href="/de/visuals/lava-flow/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #f97316, #ef4444);"></div>
<span>Lavafluss</span>
</a>
<a href="/de/visuals/mandala/" class="gk-med-card">
<div class="gk-med-dot" style="background: linear-gradient(135deg, #eab308, #a855f7);"></div>
<span>Mandala</span>
</a>
<a href="/de/visuals/dividing-cells/" class="gk-med-card">
