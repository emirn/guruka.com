---
title: "Sternenfeld - Visualisierung mit Affirmationen"
description: "Funkelnde Sterne, die durch den tiefen Weltraum treiben. Eigenen Affirmationstext hinzufügen, privat im Browser gespeichert."
full_width: true
language: "de"
---
<style>
...
<h1 class="vp-title">Sternenfeld</h1>
<p class="vp-desc">Funkelnde Sterne im tiefen Weltraum.</p>
...
<textarea id="vp-aff-input" class="vp-aff-textarea" rows="2" maxlength="300" placeholder="optional. Affirmationen hier eingeben. Text wird Zeile für Zeile angezeigt."></textarea>
</div>
<div class="vp-pace">
...
var paceLabels = ["Sehr langsam","Langsam","Normal","Schnell","Sehr schnell"];
var currentPace = 2;
var schemes = [
